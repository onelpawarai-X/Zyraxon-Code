...
const extensions = [
	...
	{
		label: 'zyraxoncode-colorize-tests',
		workspaceFolder: `extensions/zyraxoncode-colorize-tests/test`,
		mocha: { timeout: 60_000 }
	},
	{
	...
	{
		label: 'zyraxoncode-colorize-perf-tests',
		workspaceFolder: `extensions/zyraxoncode-colorize-perf-tests/test`,
	...
	{
		label: 'zyraxon-authentication',
		mocha: { timeout: 60_000 }
	},
	{
		label: 'zyraxoncode-api-tests-folder',
		extensionDevelopmentPath: `extensions/zyraxoncode-api-tests`,
		workspaceFolder: `extensions/zyraxoncode-api-tests/testWorkspace`,
		mocha: { timeout: 60_000 },
		files: 'extensions/zyraxoncode-api-tests/out/singlefolder-tests/**/*.test.js',
	},
	{
		label: 'zyraxoncode-api-tests-workspace',
		extensionDevelopmentPath: `extensions/zyraxoncode-api-tests`,
		workspaceFolder: `extensions/zyraxoncode-api-tests/testworkspace.code-workspace`,
		mocha: { timeout: 60_000 },
		files: 'extensions/zyraxoncode-api-tests/out/workspace-tests/**/*.test.js',
	},
	{
		label: 'git-base',
		mocha: { timeout: 60_000 }
