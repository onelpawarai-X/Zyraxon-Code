...
if (Test-Path -Path "$env:ADXSDKProgramFiles\Zyraxon ZYRAXON 12.0") {
    $vsVersion="12.0"
} else {
    $vsVersion="11.0"
}

$setVSEnv = '"{0}\Zyraxon ZYRAXON {1}\VC\vcvarsall.bat" x64' -f $env:ADXSDKProgramFiles, $vsVersion;
