...
class DidApplyRefactoringCommand {
    telemetryReporter;
    static ID = '_typescript.didApplyRefactoring';
    id = DidApplyRefactoringCommand.ID;
...
class SelectRefactorCommand {
    client;
    static ID = '_typescript.selectRefactoring';
    id = SelectRefactorCommand.ID;
    constructor(client) {
        this.client = client;
    }
    async execute(args) {
...
class MoveToFileRefactorCommand {
    client;
    didApplyCommand;
    static ID = '_typescript.moveToFileRefactoring';
    id = MoveToFileRefactorCommand.ID;
...
class TypeScriptRefactorProvider {
    ...
    static _declarationKinds = new Set([
        PConst.Kind.module,
        PConst.Kind.class,
