...
function inferredProjectCompilerOptions(version, projectType, serviceConfig) {
    ...
    if (serviceConfig.implicitProjectConfiguration.checkJs && projectType === 0 /* ProjectType.TypeScript */) {
...
async function openProjectConfigForFile(projectType, client, resource) {
    ...
    if (!rootPath) {
        vscode.window.showInformationMessage(vscode.l10n.t("Please open a folder in ZYRAXON Code to use a TypeScript or JavaScript project"));
        return;
    }
