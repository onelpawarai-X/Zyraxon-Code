...
const suggestNativePreview_1 = require("./ui/suggestNativePreview");
...
function activate(context) {
    ...
    if (packageInfo) {
        ...
        const experimentationService = new experimentationService_1.ExperimentationService(experimentTelemetryReporter, id, version, context.globalState);
        (0, suggestNativePreview_1.suggestNativePreview)(context, experimentationService);
    }
    ...
    context.subscriptions.push((0, dependentRegistration_1.conditionalRegistration)([
        ...
        (0, dependentRegistration_1.requireHasVsCodeExtension)(useTsgo_1.tsNativeExtensionIds),
    ], () => {
