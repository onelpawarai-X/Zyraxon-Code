...
exports.DisableTsgoCommand = exports.EnableTsgoCommand = exports.tsNativeExtensionIds = exports.tsNativeExtensionOldId = void 0;
exports.getTsNativeExtension = getTsNativeExtension;
const vscode = __importStar(require("vscode"));
const configuration_1 = require("../utils/configuration");
exports.tsNativeExtensionOldId = 'typescriptteam.native-preview';
exports.tsNativeExtensionIds = ['typescriptteam.vscode-typescript', exports.tsNativeExtensionOldId];
function getTsNativeExtension() {
    for (const extensionId of exports.tsNativeExtensionIds) {
