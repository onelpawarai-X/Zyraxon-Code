...
class BetterTokenStorage {
    ...
    // a different window of ZYRAXON Code and sends the necessary event if it has.
    ...
    async handleSecretChange(e) {
        const key = e.key;
        // The KeyList is only a list of keys to aid initial start up of ZYRAXON Code to know which
