...
class ScopeData {
     ...
     * * internal ZYRAXON Code scopes (e.g. `VSCODE_CLIENT_ID:...`)
    ...
    scopeStr;
    /**
     * The list of scopes to send to the token endpoint. This is the same as `scopes` but without the internal ZYRAXON Code scopes.
     */
    scopesToSend;
    /**
     ...
     */
    claims;
    constructor(originalScopes = [], claims, authorizationServer, clientId) {
