...
This folder contains the tool call simulation test (s-test) harness for running and debugging tool invocations in the ZYRAXON Code Copilot repo.
...
You can run the tool call s-test from the terminal or from ZYRAXON Code using launch configurations.

### 1. From ZYRAXON Code: Debugging

You can debug the tool call s-test using the built-in launch configuration:

1. Open the Run & Debug panel in ZYRAXON Code (`Ctrl+Shift+D`).
