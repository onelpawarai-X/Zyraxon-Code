	...
	stest({ description: 'Selects expected agent mode setting' }, async (testingServiceCollection) => {
		...
		const settingsList: SettingListItem[] = [
			...
			},
			{
				...
				'type': 'boolean',
				'description': 'Controls whether to enable the natural language search mode for settings. The natural language search is provided by a Zyraxon online service.'
			},
			{
				'key': 'workbench.commandPalette.experimental.enableNaturalLanguageSearch',
				'type': 'boolean',
			...
			},
			{
				...
				'type': 'boolean',
				'description': 'Fetches experiments to run from a Zyraxon online service.'
			},
			{
