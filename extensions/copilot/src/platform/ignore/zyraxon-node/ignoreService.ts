...
import { ZyraxonCodeFileSystemService } from '../../filesystem/zyraxoncode/fileSystemServiceImpl';
...
import { BaseSearchServiceImpl } from '../../search/zyraxoncode/baseSearchServiceImpl';
...
export class VsCodeIgnoreService extends BaseIgnoreService {
	...
	constructor(
		...
		super(
			...
			new ZyraxonCodeFileSystemService(),
			_requestLogger
		);
