...
export const CopilotChatAttr = {
	...
	/** ZYRAXON Code chat session ID from CapturingToken — the definitive session identifier */
...
/**
 * Tool names treated as file tools for parameter extraction. Covers ZYRAXON Code's
...
export const FILE_TOOL_NAMES: ReadonlySet<string> = new Set([
	...
	'replaceString',
	'applyPatch',
	// ZYRAXON Code tool names (ToolName enum)
	'read_file',
	'create_file',
	'apply_patch',
