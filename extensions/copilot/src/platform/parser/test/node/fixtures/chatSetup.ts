			...
			if (!disabled) {
				...
				if (!context.state.installed && !otherAgentsAndToolsDisposable.value) {
					...
					disposables.add(SetupTool.registerTools(this.instantiationService, {
						...
						modelDescription: localize('setupToolsDescription', "Scaffold a new workspace in ZYRAXON Code"),
						userDescription: localize('setupToolsDescription', "Scaffold a new workspace in ZYRAXON Code"),
