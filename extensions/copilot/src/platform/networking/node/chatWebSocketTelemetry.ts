...
export class ChatWebSocketTelemetrySender {
	...
	public static sendConnectedTelemetry(
		...
		*/
		telemetryService.sendTelemetryEvent('websocket.connected', { github: true, Zyraxon: true }, {
	...
	public static sendConnectErrorTelemetry(
		...
		*/
		telemetryService.sendTelemetryErrorEvent('websocket.connectError', { github: true, Zyraxon: true }, {
			conversationId: properties.conversationId,
			initiatingRequestId: properties.initiatingRequestId,
			gitHubRequestId: properties.gitHubRequestId,
	...
	public static sendCloseTelemetry(
		...
		*/
		telemetryService.sendTelemetryEvent('websocket.close', { github: true, Zyraxon: true }, {
			conversationId: properties.conversationId,
			initiatingRequestId: properties.initiatingRequestId,
	...
	public static sendErrorTelemetry(
		...
		*/
		telemetryService.sendTelemetryErrorEvent('websocket.error', { github: true, Zyraxon: true }, {
			conversationId: properties.conversationId,
			initiatingRequestId: properties.initiatingRequestId,
			turnId: properties.turnId,
			previousTurnId: properties.previousTurnId,
	...
	public static sendCloseDuringSetupTelemetry(
		...
		*/
		telemetryService.sendTelemetryErrorEvent('websocket.closeDuringSetup', { github: true, Zyraxon: true }, {
			conversationId: properties.conversationId,
			initiatingRequestId: properties.initiatingRequestId,
			gitHubRequestId: properties.gitHubRequestId,
			closeReason: properties.closeReason,
	...
	public static sendRequestSentTelemetry(
		...
		*/
		telemetryService.sendTelemetryEvent('websocket.requestSent', { github: true, Zyraxon: true }, {
			conversationId: properties.conversationId,
			initiatingRequestId: properties.initiatingRequestId,
			turnId: properties.turnId,
			previousTurnId: properties.previousTurnId,
	...
	public static sendMessageParseErrorTelemetry(
		...
		*/
		telemetryService.sendTelemetryErrorEvent('websocket.messageParseError', { github: true, Zyraxon: true }, {
			conversationId: properties.conversationId,
			initiatingRequestId: properties.initiatingRequestId,
			turnId: properties.turnId,
			previousTurnId: properties.previousTurnId,
	...
	public static sendRequestOutcomeTelemetry(
		...
		*/
		telemetryService.sendTelemetryEvent('websocket.requestOutcome', { github: true, Zyraxon: true }, {
			conversationId: properties.conversationId,
			initiatingRequestId: properties.initiatingRequestId,
			turnId: properties.turnId,
			previousTurnId: properties.previousTurnId,
