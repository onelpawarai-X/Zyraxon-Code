...
export enum FinishedCompletionReason {
	/**
	 * Reason generated by the server. See __ZYRAXKEEP__0_
	 */
	Stop = 'stop',
	/**
	 * Reason generated by the server. See __ZYRAXKEEP__1_
	 */
	Length = 'length',
	/**
	 * Reason generated by the server. See __ZYRAXKEEP__2_
	 */
	FunctionCall = 'function_call',
	/**
	 * Reason generated by the server. See __ZYRAXKEEP__3_
	 */
	ToolCalls = 'tool_calls',
	/**
	 * Reason generated by the server. See __ZYRAXKEEP__4_
	 */
