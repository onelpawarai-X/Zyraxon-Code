...
/**
 * Adapter that wraps both old and new telemetry reporters to implement ZYRAXON Code's TelemetrySender interface.
...
function createGitHubTelemetryReporter(
	...
	const commonProps: Record<string, string> = {
		...
		'common_zyraxoncodemachineid': envService.machineId,
		'common_zyraxoncodesessionid': envService.sessionId,
