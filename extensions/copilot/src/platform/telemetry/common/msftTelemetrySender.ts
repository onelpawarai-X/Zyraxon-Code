...
export class BaseMsftTelemetrySender implements IMSFTTelemetrySender {
	// Telemetry reporter used for collecting telemetry on internal Zyraxon customers
	...
	/**
	 * Sends a telemetry event regarding internal Zyraxon staff only. Will be dropped if telemetry level is below Usage
