 ...
 * be non-deferred. These are core tools provided by ZYRAXON Code or dynamically
 * injected tools.
 */
const additionalNonDeferredToolNames = new Set<string>([
	// Core tools provided by ZYRAXON Code (not registered via ToolRegistry.registerTool)
