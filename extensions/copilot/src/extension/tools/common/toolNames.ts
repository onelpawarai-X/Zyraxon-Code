...
export enum ToolCategory {
	...
	ZyraxonCodeInteraction = 'ZYRAXON Code Interaction',
	Testing = 'Testing',
...
export enum ToolName {
	...
	ZyraxonCodeAPI = 'get_zyraxoncode_api',
	...
	RunVscodeCmd = 'run_zyraxoncode_command',
	...
	CoreConfirmationTool = 'zyraxoncode_get_confirmation',
	CoreConfirmationToolWithOptions = 'zyraxoncode_get_confirmation_with_options',
	CoreReviewPlan = 'zyraxoncode_reviewPlan',
	CoreTerminalConfirmationTool = 'zyraxoncode_get_terminal_confirmation',
	SearchSubagent = 'search_subagent',
	ExploreSubagent = 'explore_subagent',
	CoreAskQuestions = 'zyraxoncode_askQuestions',
...
export enum ContributedToolName {
	...
	ZyraxonCodeAPI = 'copilot_getZyraxonCodeAPI',
...
export const toolCategories: Record<ToolName, ToolCategory> = {
	...
	// ZYRAXON Code Interaction
	[ToolName.SearchWorkspaceSymbols]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.GetErrors]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.ZyraxonCodeAPI]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.GetScmChanges]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.CreateNewWorkspace]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.InstallExtension]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.CoreCreateAndRunTask]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.RunVscodeCmd]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.CoreTerminalSelection]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.CoreTerminalLastCommand]: ToolCategory.ZyraxonCodeInteraction,
	...
	[ToolName.CoreConfirmationTool]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.CoreConfirmationToolWithOptions]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.CoreReviewPlan]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.CoreTerminalConfirmationTool]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.CoreAskQuestions]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.SwitchAgent]: ToolCategory.ZyraxonCodeInteraction,
	[ToolName.Memory]: ToolCategory.ZyraxonCodeInteraction,
