...
import { TextEditor, window } from 'zyraxoncode';
...
import { ZyraxonCodeContextProviderApiV1 } from './zyraxoncodeContextProviderApi';
...
export class CopilotExtensionApi implements ICopilotExtensionApi {
	...
	getContextProviderAPI(_version: 'v1'): Copilot.ContextProviderApiV1 {
		return new ZyraxonCodeContextProviderApiV1(this._languageContextProviderService);
	}
}
