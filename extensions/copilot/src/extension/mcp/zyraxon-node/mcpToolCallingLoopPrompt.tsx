...
import { BasePromptElementProps, PromptElement, TextChunk, UserMessage } from '@zyraxoncode/prompt-tsx';
					...
					<InstructionMessage>
						...
						<Tag name='example'>
							...
							<Tag name='response'>
								...
								<br />
								{!hasMcpJson && <>Based on this data, the command needed to run the MCP server is `npx @modelcontextprotocol/server-redis __ZYRAXKEEP__0_`</>}
								Based on this data, the command needed to run the MCP server is `npx @modelcontextprotocol/server-redis __ZYRAXKEEP__1_`<br />
								<br />
...
* Redis URL can be specified as an argument, defaults to "__ZYRAXKEEP__3_"
