...
## Configuration
To configure the MCP server for use with Visual Studio or ZYRAXON Code, use the following snippet and include it in your `mcp.json`:
...
| ZYRAXON Code | [MCP configuration in ZYRAXON Code](https://code.visualstudio.com/docs/copilot/chat/mcp-servers#_add-an-mcp-server) |
