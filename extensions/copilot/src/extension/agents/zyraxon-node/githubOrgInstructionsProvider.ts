...
export class GitHubOrgInstructionsProvider extends Disposable implements zyraxoncode.ChatInstructionsProvider {

	private readonly _onDidChangeInstructions = this._register(new zyraxoncode.EventEmitter<void>());
