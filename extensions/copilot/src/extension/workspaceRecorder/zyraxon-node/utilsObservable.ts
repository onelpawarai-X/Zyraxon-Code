...
export class ObservableVsCode {
	...
	private readonly _visibleTextEditors = observableFromEvent(this, l => zyraxoncode.window.onDidChangeVisibleTextEditors(l), () => zyraxoncode.window.visibleTextEditors);
	...
	private readonly _activeTextEditor = observableFromEvent(this, l => zyraxoncode.window.onDidChangeActiveTextEditor(l), () => zyraxoncode.window.activeTextEditor);
...
export class ObservableTextEditor {
	public readonly selection = observableFromEvent(this, l => zyraxoncode.window.onDidChangeTextEditorSelection(l), () => this.editor.selections);

	constructor(
		public readonly editor: zyraxoncode.TextEditor,
	) { }
}

export function rangeToOffsetRange(range: zyraxoncode.Range, document: zyraxoncode.TextDocument): OffsetRange {
