...
export function getAdditionalWelcomeMessage(accessor: ServicesAccessor): zyraxoncode.MarkdownString | undefined {
	...
	if (showHint) {
		...
		const messageString = new zyraxoncode.MarkdownString(zyraxoncode.l10n.t({
