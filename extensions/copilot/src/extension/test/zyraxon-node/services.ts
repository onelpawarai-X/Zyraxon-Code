...
/**
 * A default context for ZyraxonCode extension testing, building on general one in `lib`.
...
export function createExtensionTestingServices(): TestingServiceCollection {
	...
	testingServiceCollection.define(IExtensionsService, new SyncDescriptor(ZyraxonCodeExtensionsService));
