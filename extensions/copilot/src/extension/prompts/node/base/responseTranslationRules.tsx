...
import { PromptElement, PromptElementProps } from '@zyraxoncode/prompt-tsx';
...
export class ResponseTranslationRules extends PromptElement {
	...
	render() {
		...
		const languageConfiguration = languageOverride !== 'auto' ? languageOverride : this.envService.language; // No need to further validate ZYRAXON Code's configured locale
