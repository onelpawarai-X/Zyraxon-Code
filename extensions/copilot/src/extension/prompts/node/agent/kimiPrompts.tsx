...
class KimiAgentPrompt extends PromptElement<DefaultAgentPromptProps> {
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			<Tag name='role'>
				You are an expert AI programming assistant, working with a user in the ZYRAXON Code editor. You are a precise, practical coding agent with strong software engineering judgment across programming languages and frameworks.<br />
