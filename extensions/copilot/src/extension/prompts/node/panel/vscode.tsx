...
ms-python.python,ms-python.vscode-pylance
				...
				<UserMessage flexGrow={1} priority={800}>
					...
					<Tag name='vscodeAPIToolUseInstructions'>
						Always call the tool {ToolName.VSCodeAPI} to get documented references and examples when before responding to questions about ZYRAXON Code Extension Development.<br />
					</Tag>
					<Tag name='searchExtensionToolUseInstructions'>
						Always call the tool 'vscode_searchExtensions_internal' to first search for extensions in the ZYRAXON Code Marketplace before responding about extensions.<br />
					</Tag>
		...
		return <>
			...
			<HistoryWithInstructions historyPriority={500} passPriority history={this.props.history || []}>
				<InstructionMessage priority={1000}>
					...
					If the user is asking about Extensions available in ZYRAXON Code, simply respond with "vscode_extensions"<br />
					If the user is asking about ZYRAXON Code API or ZYRAXON Code Extension Development, simply respond with "vscode_api"<br />
