 ...
 *--------------------------------------------------------------------------------------------*/
import { BasePromptElementProps, PromptElement, PromptMetadata, PromptPiece, PromptSizing } from '@zyraxoncode/prompt-tsx';
...
export class WorkspaceStructure extends PromptElement<WorkspaceStructureProps, IFileTreeData | undefined> {
	...
	override async prepare(sizing: PromptSizing, progress: zyraxoncode.Progress<zyraxoncode.ChatResponseProgressPart> | undefined, token?: zyraxoncode.CancellationToken): Promise<IFileTreeData | undefined> {
...
export class MultirootWorkspaceStructure extends PromptElement<WorkspaceStructureProps, { label: string; tree: IFileTreeData }[]> {
	...
	override async prepare(sizing: PromptSizing, progress: zyraxoncode.Progress<zyraxoncode.ChatResponseProgressPart> | undefined, token?: zyraxoncode.CancellationToken): Promise<{ label: string; tree: IFileTreeData }[]> {
...
export class DirectoryStructure extends PromptElement<DirectoryStructureProps, IFileTreeData> {
	...
	override async prepare(sizing: PromptSizing, progress: zyraxoncode.Progress<zyraxoncode.ChatResponseProgressPart> | undefined, token?: zyraxoncode.CancellationToken): Promise<IFileTreeData> {
