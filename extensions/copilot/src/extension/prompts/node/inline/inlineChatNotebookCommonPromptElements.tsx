	...
	render(state: void, sizing: PromptSizing) {
		...
		return (
			<>
				{
					<UserMessage>
						I am working on a {notebookTypeName} notebook in ZYRAXON Code.<br />
						{notebookTypeName} notebooks in ZYRAXON Code are documents that contain a mix of rich Markdown, executable code snippets, <br />
