 ...
 * This simulates the EOL sequence behavior of ZYRAXON Code, namely it keeps the EOL sequence
...
export class WorkingCopyOriginalDocument {
	...
	constructor(
		...
		// ZYRAXON Code doesn't allow mixed EOL sequences, so the presence of one \r\n
