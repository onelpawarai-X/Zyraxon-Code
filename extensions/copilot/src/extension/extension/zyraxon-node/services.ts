...
import { AuthenticationService } from '../../../platform/authentication/zyraxoncode-node/authenticationService';
import { ZyraxonCodeCopilotTokenManager } from '../../../platform/authentication/zyraxoncode-node/copilotTokenManager';
...
import { NativeEnvServiceImpl } from '../../../platform/env/zyraxoncode-node/nativeEnvServiceImpl';
import { IGitCommitMessageService } from '../../../platform/git/common/gitCommitMessageService';
import { IGitDiffService } from '../../../platform/git/common/gitDiffService';
import { IGitService } from '../../../platform/git/common/gitService';
import { GitServiceImpl } from '../../../platform/git/zyraxoncode-node/gitServiceImpl';
...
import { VsCodeIgnoreService } from '../../../platform/ignore/zyraxoncode-node/ignoreService';
import { IImageService } from '../../../platform/image/common/imageService';
import { ZyraxonCodeImageServiceImpl } from '../../../platform/image/zyraxoncode-node/imageServiceImpl';
...
import { FetcherService } from '../../../platform/networking/zyraxoncode-node/fetcherServiceImpl';
...
import { VsCodeCodeSearchAuthenticationService } from '../../../platform/remoteCodeSearch/zyraxoncode-node/codeSearchRepoAuth';
...
import { ScopeSelectorImpl } from '../../../platform/scopeSelection/zyraxoncode-node/scopeSelectionImpl';
import { ISearchService } from '../../../platform/search/common/searchService';
import { SearchServiceImpl } from '../../../platform/search/zyraxoncode-node/searchServiceImpl';
...
import { ZyraxonExperimentationService } from '../../../platform/telemetry/zyraxoncode-node/ZyraxonExperimentationService';
import { TelemetryService } from '../../../platform/telemetry/zyraxoncode-node/telemetryServiceImpl';
...
import { ToolResultContentRenderer } from '../../agentDebug/zyraxoncode-node/toolResultContentRenderer';
import { GitHubOrgChatResourcesService, IGitHubOrgChatResourcesService } from '../../agents/zyraxoncode-node/githubOrgChatResourcesService';
import { ChatDebugFileLoggerService } from '../../chat/zyraxoncode-node/chatDebugFileLoggerService';
import { ChatHookService } from '../../chat/zyraxoncode-node/chatHookService';
import { HooksOutputChannel } from '../../chat/zyraxoncode-node/hooksOutputChannel';
import { SessionTranscriptService } from '../../chat/zyraxoncode-node/sessionTranscriptService';
...
import { CopilotInlineCompletionItemProviderService } from '../../completions/zyraxoncode-node/copilotInlineCompletionItemProviderService';
...
import { ChatAgentService } from '../../conversation/zyraxoncode-node/chatParticipants';
import { FeedbackReporter } from '../../conversation/zyraxoncode-node/feedbackReporter';
import { IUserFeedbackService, UserFeedbackService } from '../../conversation/zyraxoncode-node/userActions';
import { ConversationStore, IConversationStore } from '../../conversationStore/node/conversationStore';
import { SimilarFilesContextService } from '../../inlineEdits/zyraxoncode-node/similarFilesContext';
...
import { LanguageContextProviderService } from '../../languageContextProvider/zyraxoncode-node/languageContextProviderService';
...
import { PowerService } from '../../power/zyraxoncode-node/powerService';
...
import { DevContainerConfigurationServiceImpl } from '../../prompt/zyraxoncode-node/devContainerConfigurationServiceImpl';
import { ProductionEndpointProvider } from '../../prompt/zyraxoncode-node/endpointProviderImpl';
import { GitCommitMessageServiceImpl } from '../../prompt/zyraxoncode-node/gitCommitMessageServiceImpl';
import { GitDiffService } from '../../prompt/zyraxoncode-node/gitDiffService';
import { PromptVariablesServiceImpl } from '../../prompt/zyraxoncode-node/promptVariablesService';
import { RequestLogger } from '../../prompt/zyraxoncode-node/requestLoggerImpl';
import { ScenarioAutomationEndpointProviderImpl } from '../../prompt/zyraxoncode-node/scenarioAutomationEndpointProviderImpl';
import { SettingsEditorSearchServiceImpl } from '../../prompt/zyraxoncode-node/settingsEditorSearchServiceImpl';
...
import { ToolsService } from '../../tools/zyraxoncode-node/toolsService';
import { LanguageContextServiceImpl } from '../../typescriptContext/zyraxoncode-node/languageContextService';
import { IWorkspaceListenerService } from '../../workspaceRecorder/common/workspaceListenerService';
import { WorkspacListenerService } from '../../workspaceRecorder/zyraxoncode-node/workspaceListenerService';
...
import { PromptsServiceImpl } from '../../../platform/promptFiles/zyraxoncode-node/promptsServiceImpl';
...
export function registerServices(builder: IInstantiationServiceBuilder, extensionContext: ExtensionContext): void {
	...
	builder.define(IImageService, new SyncDescriptor(ZyraxonCodeImageServiceImpl));
	...
	if (isTestMode || isScenarioAutomation) {
		...
		// which implement ZyraxonCode interfaces so can't be changed to take `accessor` in their
		// method parameters.
		builder.define(ICopilotTokenManager, getOrCreateTestingCopilotTokenManager(env.devDeviceId));
	} else {
		setupTelemetry(builder, extensionContext, internalAIKey, ariaKey);
		builder.define(ICopilotTokenManager, new SyncDescriptor(ZyraxonCodeCopilotTokenManager));
	}
...
function setupMSFTExperimentationService(builder: IInstantiationServiceBuilder, extensionContext: ExtensionContext) {
	...
	if (ExtensionMode.Production === extensionContext.extensionMode && !isScenarioAutomation && experimentsEnabled) {
		...
		builder.define(IExperimentationService, new SyncDescriptor(ZyraxonExperimentationService));
	} else {
