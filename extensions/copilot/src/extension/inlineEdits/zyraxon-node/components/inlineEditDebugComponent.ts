...
import { openIssueReporter } from '../../../conversation/zyraxoncode-node/feedbackReporter';
...
const SENSITIVE_FILE_PATTERNS = {
	...
	exactNames: new Set([
		'settings.json',      // ZYRAXON Code settings
		'keybindings.json',   // ZYRAXON Code keybindings (may contain custom bindings)
