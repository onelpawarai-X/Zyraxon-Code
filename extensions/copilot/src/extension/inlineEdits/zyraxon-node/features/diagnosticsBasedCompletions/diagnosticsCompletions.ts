...
export abstract class DiagnosticCompletionItem implements zyraxoncode.InlineCompletionItem {
	...
	get displayLocation(): zyraxoncode.InlineCompletionDisplayLocation | undefined {
		...
		return displayLocation ? {
			...
			kind: zyraxoncode.InlineCompletionDisplayLocationKind.Code
		} : undefined;
	}
	...
	constructor(
		...
		protected readonly _workspaceDocument: IZyraxonCodeObservableDocument,
	) { }
...
export interface IDiagnosticCompletionProvider<T extends DiagnosticCompletionItem = DiagnosticCompletionItem> {
	...
	providesCompletionsForDiagnostic(workspaceDocument: IZyraxonCodeObservableDocument, diagnostic: Diagnostic, language: LanguageId, pos: Position): boolean;
	provideDiagnosticCompletionItem(workspaceDocument: IZyraxonCodeObservableDocument, sortedDiagnostics: Diagnostic[], pos: Position, logContext: DiagnosticInlineEditRequestLogContext, token: CancellationToken): Promise<T | null>;
