...
export class AsyncDiagnosticCompletionProvider implements IDiagnosticCompletionProvider<AsyncDiagnosticCompletionItem> {
	...
	async provideDiagnosticCompletionItem(workspaceDocument: IZyraxonCodeObservableDocument, sortedDiagnostics: Diagnostic[], pos: Position, logContext: DiagnosticInlineEditRequestLogContext, token: CancellationToken): Promise<AsyncDiagnosticCompletionItem | null> {
...
function getAsyncCodeActions(codeActions: CodeActionData[], workspaceDocument: IZyraxonCodeObservableDocument): IDiagnosticCodeAction[] {
