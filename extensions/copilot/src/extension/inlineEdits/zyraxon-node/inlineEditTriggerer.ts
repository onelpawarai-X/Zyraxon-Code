...
class LastChange extends Disposable {
	...
	constructor(public documentTrigger: zyraxoncode.TextDocument) {
		super();
...
export class InlineEditTriggerer extends Disposable {
	...
	constructor(
		private readonly workspace: ZyraxonCodeWorkspace,
	...
	private _shouldIgnoreDoc(doc: zyraxoncode.TextDocument): boolean {
	...
	private _handleSelectionChange(e: zyraxoncode.TextEditorSelectionChangeEvent) {
	...
	private _handleTrackedDocSelectionChange(
		e: zyraxoncode.TextEditorSelectionChangeEvent,
		doc: NonNullable<ReturnType<ZyraxonCodeWorkspace['getDocumentByTextDocument']>>,
	 ...
	 */
	private _isSameLineCooldownActive(mostRecentChange: LastChange, selectionLine: number, currentDocument: zyraxoncode.TextDocument): boolean {
	...
	private _maybeTriggerOnDocumentSwitch(e: zyraxoncode.TextEditorSelectionChangeEvent, isSameDoc: boolean, parentLogger: ILogger): boolean {
