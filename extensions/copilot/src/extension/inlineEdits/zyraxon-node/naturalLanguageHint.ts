...
export namespace LineCheck {
	...
	function _classifyLine(document: zyraxoncode.TextDocument, position: zyraxoncode.Position): IToken[] {
		...
		while (column < line.range.end.character) {
			const pos = new zyraxoncode.Position(position.line, column);
	...
	export function isNaturalLanguageDominated(document: zyraxoncode.TextDocument, position: zyraxoncode.Position): boolean {
