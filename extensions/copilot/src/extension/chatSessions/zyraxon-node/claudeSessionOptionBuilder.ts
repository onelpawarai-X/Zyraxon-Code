...
export class ClaudeSessionOptionBuilder {
	...
	async buildNewSessionGroups(): Promise<zyraxoncode.ChatSessionProviderOptionGroup[]> {
	...
	async buildExistingSessionGroups(permissionMode: PermissionMode, folderUri: URI | undefined): Promise<zyraxoncode.ChatSessionProviderOptionGroup[]> {
		const groups: zyraxoncode.ChatSessionProviderOptionGroup[] = [];
	...
	buildPermissionModeGroup(): zyraxoncode.ChatSessionProviderOptionGroup {
	...
	async buildNewFolderGroup(): Promise<zyraxoncode.ChatSessionProviderOptionGroup | undefined> {
	...
	buildExistingFolderGroup(folderUri: URI): zyraxoncode.ChatSessionProviderOptionGroup {
		const folderItem: zyraxoncode.ChatSessionProviderOptionItem = {
	...
	async getFolderOptionItems(): Promise<zyraxoncode.ChatSessionProviderOptionItem[]> {
		const workspaceFolders = this._workspaceService.getWorkspaceFolders();
	 ...
	 */
	getSelections(groups: readonly zyraxoncode.ChatSessionProviderOptionGroup[]): { permissionMode?: PermissionMode; folderUri?: URI } {
