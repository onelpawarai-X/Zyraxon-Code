...
export interface CreatePullRequestOptions {
	readonly repositoryUri: zyraxoncode.Uri;
...
export interface IPullRequestCreationService {
	 ...
	 */
	createPullRequest(options: CreatePullRequestOptions, token: zyraxoncode.CancellationToken): Promise<string | undefined>;
}
...
export class PullRequestCreationService extends Disposable implements IPullRequestCreationService {
	...
	async createPullRequest(options: CreatePullRequestOptions, token: zyraxoncode.CancellationToken): Promise<string | undefined> {
