 ...
 *
 * By default all `zyraxoncode.workspace.workspaceFolders` are treated as projects.
 */
...
export interface PythonTerminalRunApi {
	 ...
	 *
	 * Note:
	 *  - If you restart ZYRAXON Code, this will create a new terminal, this is a limitation of ZYRAXON Code.
