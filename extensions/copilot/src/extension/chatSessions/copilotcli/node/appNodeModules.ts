...
/**
 * Roots under ZYRAXON Code's app root that may hold its bundled `node_modules`, in
 * priority order.
 *
 ...
 * `node_modules`. Consumers that reach into ZYRAXON Code's own modules for native
...
/**
 * Resolves a path to one of ZYRAXON Code's bundled module resources, checking both
