...
export function registerDiffCommands(logger: ILogger, diffState: DiffStateManager): zyraxoncode.Disposable[] {
	const disposables: zyraxoncode.Disposable[] = [];

	disposables.push(
		zyraxoncode.commands.registerCommand(ACCEPT_DIFF_COMMAND, () => {
	...
	disposables.push(
		zyraxoncode.commands.registerCommand(REJECT_DIFF_COMMAND, () => {
