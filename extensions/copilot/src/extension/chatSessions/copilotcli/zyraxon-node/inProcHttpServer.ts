...
export class InProcHttpServer extends Disposable {
	...
	private readonly _onDidClientConnect = this._register(new zyraxoncode.EventEmitter<string>());
	public readonly onDidClientConnect = this._onDidClientConnect.event;
	private readonly _onDidClientDisconnect = this._register(new zyraxoncode.EventEmitter<string>());
	...
	async start(
	...
	): Promise<{ serverUri: zyraxoncode.Uri; headers: Record<string, string> }> {
		...
		try {
			...
			return {
				serverUri: zyraxoncode.Uri.from({
