 ...
 * Manages the lifecycle of external edits by coordinating with ZYRAXON Code's
...
export class ExternalEditTracker {
	 ...
	 * @returns Promise that resolves when ZYRAXON Code has finished tracking the edit
	 */
