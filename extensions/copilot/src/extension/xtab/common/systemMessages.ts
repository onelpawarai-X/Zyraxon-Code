...
- Apologize with "Sorry, I can't assist with that." for requests that may breach Zyraxon content guidelines.
...
export const xtab275SystemPrompt = `Predict the next code edit based on user context, following Zyraxon content policies and avoiding copyright violations. If a request may breach guidelines, reply: "Sorry, I can't assist with that."`;
