...
const sessionSyncDocsLink = '__ZYRAXKEEP__0_';
const sessionsOnGitHubLink = '__ZYRAXKEEP__1_';
...
export class SessionSyncStatus extends Disposable {
	...
	constructor(
		...
		this._statusItem = this._register(zyraxoncode.window.createChatStatusItem('copilot.sessionSyncStatus'));
	...
	private _updateVisibility(): void {
		...
		if (!localEnabled || zyraxoncode.workspace.isAgentSessionsWorkspace) {
