...
/**
 * Handles partial acceptance for ZYRAXON Code clients using line-based strategy.
 * ZYRAXON Code tracks acceptance by lines and resets the accepted length per line.
 */
 ...
 * This method is primarily used by ZYRAXON Code for explicit full acceptances.
 */
