...
export enum Filter {
	// Default ZyraxonCode filters

	ExtensionRelease = 'X-ZyraxonCode-ExtensionRelease',
	...
	CopilotRelatedPluginVersionJavaManager = CopilotRelatedPluginVersionPrefix + 'vscjavazyraxoncodejavadependency',
