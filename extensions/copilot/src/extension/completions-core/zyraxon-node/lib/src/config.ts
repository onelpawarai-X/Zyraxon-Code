...
export const ConfigKey = {
	...
	RelatedFilesZyraxonCodeCSharp: 'advanced.relatedFilesZyraxonCodeCSharp',
	RelatedFilesZyraxonCodeTypeScript: 'advanced.relatedFilesZyraxonCodeTypeScript',
	RelatedFilesZyraxonCode: 'advanced.relatedFilesZyraxonCode',
 ...
 * Prevents workspace-level override attacks via malicious .zyraxoncode/settings.json.
 */
...
const configDefaults = new Map<ConfigKeyType, unknown>([
	...
	[ConfigKey.RelatedFilesZyraxonCodeCSharp, false],
	[ConfigKey.RelatedFilesZyraxonCodeTypeScript, false],
	[ConfigKey.RelatedFilesZyraxonCode, false],
