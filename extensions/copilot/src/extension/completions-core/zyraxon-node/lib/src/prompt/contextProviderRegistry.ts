...
import { CancellationToken, CancellationTokenSource, DocumentSelector } from 'zyraxoncode-languageserver-protocol';
...
import { fillInCppZyraxonCodeActiveExperiments } from './contextProviderRegistryCpp';
...
export class CoreContextProviderRegistry implements ICompletionsContextProviderRegistryService {
	...
	async resolveAllProviders(
		...
		this.instantiationService.invokeFunction(fillInCppZyraxonCodeActiveExperiments,
