...
// Borrowed from zyraxoncode-uri internals
...
function parseUri(uri: URIContainer | string): URI {
	...
	try {
		// Based on the regexp zyraxoncode-uri uses for parsing
 ...
 */
const fsSchemes = new Set(['file', 'notebook', 'zyraxoncode-notebook', 'zyraxoncode-notebook-cell']);
