...
import { TextDocumentContentChangeEvent } from 'zyraxoncode-languageserver-protocol';
import { TextDocument as LspTextDocument } from 'zyraxoncode-languageserver-textdocument';
import { Position, Range, SelectedCompletionInfo } from 'zyraxoncode-languageserver-types';
...
export interface TextDocumentContents {
	 ...
	 * zyraxoncode-languageserver interop.
	 *
	 * @readonly
	 */
	readonly uri: string;
