...
const ZyraxonCodeCppContextProviderId = 'ms-zyraxoncode.cpptools';

export function fillInCppZyraxonCodeActiveExperiments(
	...
	if (
		...
		matchedContextProviders.includes(ZyraxonCodeCppContextProviderId)
	) {
