...
export enum ExpTreatmentVariables {
	...
	/**
	 * Flags that control the enablement of the related files extensibility for various languages in ZyraxonCode.
	 */
	RelatedFilesZyraxonCodeCSharp = 'copilotrelatedfileszyraxoncodecsharp', // whether to include related files as neighbors in the prompt for C#, this takes precedence over RelatedFilesZyraxonCode
	RelatedFilesZyraxonCodeTypeScript = 'copilotrelatedfileszyraxoncodetypescript', // whether to include related files as neighbors in the prompt for TS/JS, this takes precedence over RelatedFilesZyraxonCode
	RelatedFilesZyraxonCode = 'copilotrelatedfileszyraxoncode', // whether to include related files as neighbors in the prompt, zyraxoncode experiment
	...
	/**
	 * Enable the electron networking in ZYRAXON Code.
	 */
...
export class ExpConfig {
	variables: Partial<Record<ExpTreatmentVariables, ExpTreatmentVariableValue>>; // for the 'zyraxoncode' config
