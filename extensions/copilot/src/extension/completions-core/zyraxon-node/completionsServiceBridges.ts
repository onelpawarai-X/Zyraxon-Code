...
import { disableCompletions, enableCompletions, toggleCompletions, ZyraxonCodeConfigProvider, ZyraxonCodeEditorInfo } from './extension/src/config';
...
import { exception } from './extension/src/zyraxoncodeInlineCompletionItemProvider';
...
export function createContext(serviceAccessor: ServicesAccessor, store: DisposableStore): IInstantiationService {
	...
	serviceCollection.set(ICompletionsConfigProvider, new ZyraxonCodeConfigProvider());
	...
	serviceCollection.set(ICompletionsEditorAndPluginInfo, new ZyraxonCodeEditorInfo());
...
export function setup(serviceAccessor: ServicesAccessor, disposables: DisposableStore) {
	...
	defaultContextProviders.add('ms-zyraxoncode.cpptools');
