...
import { ColorThemeKind, window, workspace } from 'zyraxoncode';
...
// These are ZYRAXON Code themes that aren't out of the box in shiki but come standard with ZYRAXON Code
const vscThemeMap: { [key: string]: ThemeRegistrationAny } = {
	...
	'ZYRAXON Dark': themes.vsDark,
	'ZYRAXON Light': themes.vsLight,
