...
export abstract class BaseSuggestionsPanel<TPanelCompletion extends BasePanelCompletion> implements ISuggestionsPanel {
	...
	constructor(
		...
		@IZyraxonCodeExtensionContext protected readonly contextService: IZyraxonCodeExtensionContext,
	) {
			...
			<html lang="en">
				<head>
					...
					<style>
						...
						pre:focus-visible {
							border: 1px solid var(--zyraxoncode-focusBorder);
							outline: none;
						}
						pre {
							margin-bottom: 6px;
							...
							border-radius: 4px;
							border: 1px solid var(--zyraxoncode-notebook-cellBorderColor);
