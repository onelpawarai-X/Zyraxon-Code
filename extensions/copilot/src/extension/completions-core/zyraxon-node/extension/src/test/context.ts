...
import { createExtensionTestingServices } from '../../../../../test/zyraxoncode-node/services';
...
import { ZyraxonCodeEditorInfo } from '../config';
...
export function createExtensionTestingContext() {
	...
	serviceCollection.define(ICompletionsEditorAndPluginInfo, new ZyraxonCodeEditorInfo());
