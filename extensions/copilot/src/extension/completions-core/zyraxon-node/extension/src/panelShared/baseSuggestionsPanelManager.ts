...
import { TextDocument, Uri, ViewColumn, WebviewPanel, commands, window } from 'zyraxoncode';
...
export abstract class BaseSuggestionsPanelManager<TPanelCompletion extends BasePanelCompletion>
	...
	constructor(
		...
		@IZyraxonCodeExtensionContext protected readonly _extensionContext: IZyraxonCodeExtensionContext,
	) { }
