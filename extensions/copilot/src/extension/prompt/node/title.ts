...
export class ChatTitleProvider implements zyraxoncode.ChatTitleProvider {
	...
	async provideChatTitle(
		...
		// Extract the parent session ID from the context's sessionResource (provided by ZYRAXON Code)
