...
This document explains the architecture of trajectory logging in ZYRAXON Code Copilot Chat, 
...
│  2. token.chatSessionId         │  ZYRAXON Code chat session ID     │
│  3. generateSessionId(label)    │  Fallback: hash + timestamp  │
└─────────────────────────────────────────────────────────────────┘
```

This enables:
- **Main trajectories**: Use ZYRAXON Code's chat session ID for 1:1 mapping
