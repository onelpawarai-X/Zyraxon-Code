...
import { CancellationToken, LanguageModelChatMessage, LanguageModelChatMessage2, LanguageModelResponsePart2, Progress, ProvideLanguageModelChatResponseOptions } from 'zyraxoncode';
...
export class AzureBYOKModelProvider extends AbstractCustomOAIBYOKModelProvider {
	...
	override async provideLanguageModelChatResponse(
		...
		const session: zyraxoncode.AuthenticationSession = await zyraxoncode.authentication.getSession(
			AzureAuthMode.Zyraxon_AUTH_PROVIDER,
