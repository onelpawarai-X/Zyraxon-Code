...
5. Install any required ZYRAXON Code extensions based on the chosen language (e.g., Python extension for Python projects).
6. Inform the user that they can now debug this MCP server using ZYRAXON Code.
...
1. Call the tool `copilot_runVscodeCommand` to correctly create a new Python script project in ZYRAXON Code. Call the command with the following arguments.
