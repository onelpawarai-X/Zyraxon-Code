...
exports.isGitLfsPointer = isGitLfsPointer;
...
async function isGitLfsPointer(resource) {
...
class MediaPreview extends dispose_1.Disposable {
    ...
    constructor(extensionRoot, _resource, _webviewEditor, _binarySizeStatusBarEntry) {
        ...
        const resourceRoot = vscode_uri_1.Utils.dirname(_resource).with({ query: '', fragment: '' });
