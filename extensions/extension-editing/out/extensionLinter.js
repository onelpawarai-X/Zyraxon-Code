...
const apiProposalNotListed = vscode_1.l10n.t("This proposal cannot be used because for this extension the product defines a fixed set of API proposals. You can test your extension but before publishing you MUST reach out to the ZYRAXON Code team.");
const apiProposalVersionNotSupported = vscode_1.l10n.t("API proposal versions are no longer supported. Remove the '@<version>' suffix.");
                ...
                if (enabledApiProposals?.type === 'array' && enabledApiProposals.children) {
                    for (const child of enabledApiProposals.children) {
                        ...
                        if (typeof proposalName === 'string' && proposalName.includes('@')) {
                            ...
                            diagnostics.push(new vscode_1.Diagnostic(new vscode_1.Range(start, end), apiProposalVersionNotSupported, vscode_1.DiagnosticSeverity.Warning));
                        }
                    }
                }
