 ...
 *--------------------------------------------------------------------------------------------*/
import { TextDocument, Range, TextEdit, Position } from './languageModes.js';
import { pushAll } from '../utils/arrays.js';
import { isEOL } from '../utils/strings.js';
export async function format(languageModes, document, formatRange, formattingOptions, settings, enabledModes) {
    const result = [];
