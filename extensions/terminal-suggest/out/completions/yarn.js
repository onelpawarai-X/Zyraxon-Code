...
exports.createCLIsGenerator = exports.dependenciesGenerator = exports.nodeClis = exports.yarnScriptParserDirectives = void 0;
const npm_1 = require("./npm");
exports.yarnScriptParserDirectives = {
...
const getGlobalPackagesGenerator = {
...
const completionSpec = {
    ...
    generateSpec: async (tokens, executeShellCommand) => {
        const binaries = (await executeShellCommand({
            command: 'bash',
            args: [
                '-c',
        ...
        const subcommands = binaries
            .filter((name) => exports.nodeClis.has(name))
            .map((name) => ({
            name: name,
    ...
    args: {
        generators: npm_1.npmScriptsGenerator,
        filterStrategy: 'fuzzy',
        parserDirectives: exports.yarnScriptParserDirectives,
        isOptional: true,
        isCommand: true,
    },
    options: [
    ...
    subcommands: [
        {
            ...
            args: {
                name: 'package',
                generators: npm_1.npmSearchGenerator,
                debounce: true,
                isVariadic: true,
            },
            options: [
        ...
        },
        {
            ...
            args: {
                name: 'cli',
                generators: exports.createCLIsGenerator,
        ...
        },
        {
            ...
            generateSpec: async (_tokens, executeShellCommand) => {
                const version = (await executeShellCommand({
                    command: 'yarn',
                    args: ['--version'],
                })).stdout;
                ...
                try {
                    ...
                    const subcommands = workspacesDefinitions.map(({ name, location }) => ({
                        name,
