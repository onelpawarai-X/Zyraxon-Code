...
const troubleshootingOptions = (cliName) => [
    ...
    {
        name: '--telemetry',
        description: 'Shows all telemetry events which ZYRAXON Code collects',
    },
    {
        name: '--transient',
...
exports.codeTunnelSubcommands = [
                ...
                subcommands: [
                    {
                        ...
                        options: [
                            ...
                            ...exports.globalTunnelOptions, ...exports.tunnelHelpOptions
                        ],
                    },
                    {
                        name: 'uninstall',
        ...
        subcommands: [
            {
                ...
                options: [...agentHostOptions, ...exports.globalTunnelOptions, ...exports.tunnelHelpOptions],
            },
            {
                name: 'ps',
            ...
            },
            {
                ...
                options: [...agentConnectionOptions, ...exports.globalTunnelOptions, ...exports.tunnelHelpOptions],
            },
            {
                name: 'kill',
    ...
    {
        name: 'serve-web',
        description: 'Runs a local web version of ZYRAXON Code',
        options: [
            {
                name: '--host',
