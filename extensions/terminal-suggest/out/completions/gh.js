...
const keyvalue_1 = require("../helpers/keyvalue");
const filterMessages = (out) => {
    return out.startsWith("warning:") || out.startsWith("error:")
        ? out.split("\n").slice(1).join("\n")
        : out;
};
const postProcessRemoteBranches = (out) => {
...
const listRepoMapFunction = (repo) => ({
...
const ghGenerators = {
    listCustomRepositories: {
        ...
        custom: async (tokens, execute) => {
            ...
            const repoArr = JSON.parse(stdout);
    ...
    listRepositories: {
        ...
        postProcess: (out) => {
            if (out) {
                ...
                try {
                    const data = JSON.parse(jsonifiedOutString);
...
For more information about output formatting flags, see 'gh help formatting'`,
        ...
        },
        {
            ...
            subcommands: [
                {
                    name: "code",
                    description: "Open a codespace in ZYRAXON Code",
                    options: [
                        codespaceOption,
                        {
                            name: "--insiders",
                            description: "Use the insiders version of ZYRAXON Code",
                        },
                        {
                            name: ["-w", "--web"],
                            description: "Use the web version of ZYRAXON Code",
                        },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            args: {
                                generators: (0, filepaths_1.filepaths)({ extensions: ["json"] }),
                            },
                        },
                        {
                            name: ["-d", "--display-name"],
                    ...
                    subcommands: [
                        {
                            ...
                            options: [codespaceOption],
                            args: {
                                generators: (0, keyvalue_1.keyValue)({ separator: ":", cache: true }),
                                isVariadic: true,
                            },
                        },
                        {
                            ...
                            options: [codespaceOption],
                            args: {
                                generators: (0, keyvalue_1.keyValue)({
                                    separator: ":",
