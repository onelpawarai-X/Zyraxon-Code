...
exports.npmScriptsGenerator = exports.dependenciesGenerator = exports.npmSearchGenerator = exports.createNpmSearchHandler = void 0;
function uninstallSubcommand(named) {
    return {
        name: named,
        description: 'Uninstall a package',
        args: {
            name: 'package',
            generators: exports.dependenciesGenerator,
...
const atsInStr = (s) => (s.match(/@/g) || []).length;
const createNpmSearchHandler = (keywords) => async (context, executeShellCommand, shellContext) => {
...
exports.createNpmSearchHandler = createNpmSearchHandler;
// GENERATORS
exports.npmSearchGenerator = {
    ...
    custom: (0, exports.createNpmSearchHandler)(),
};
            ...
            if (scripts) {
                return Object.entries(scripts).map(([scriptName, scriptContents]) => {
                    const icon = npmClient === 'yarn'
                        ? 'fig://icon?type=yarn'
                        : 'fig://icon?type=npm';
                    const customScripts = figCompletions[scriptName];
                    return {
                        name: scriptName,
                        icon,
    ...
    subcommands: [
        {
            ...
            args: {
                name: 'package',
                isOptional: true,
                generators: exports.npmSearchGenerator,
                debounce: true,
                isVariadic: true,
            },
            options: [
        ...
        },
        {
            ...
            args: {
                ...
                filterStrategy: 'fuzzy',
                generators: exports.npmScriptsGenerator,
            },
        },
        {
            name: 'init',
