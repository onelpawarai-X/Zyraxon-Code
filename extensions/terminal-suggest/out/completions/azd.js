    ...
    subcommands: [
        ...
        },
        {
            ...
            subcommands: [
                {
                    name: ['agent'],
                    description: 'Ship agents with Zyraxon Foundry from your terminal. (Preview)',
                    subcommands: [
                        {
                            name: ['code'],
                            ...
                            subcommands: [
                                {
                                    ...
                                    options: [
                                        ...
                                        },
                                        {
                                            ...
                                            description: 'Zyraxon Foundry project endpoint URL',
                                            args: [
                                                {
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                {
                                    name: ['--project-id', '-p'],
                                    description: 'Existing Zyraxon Foundry Project Id to initialize your azd environment with',
                                    args: [
                                        {
                                            name: 'project-id',
                                        },
                ...
                {
                    name: ['connection'],
                    description: 'Manage Zyraxon Foundry Connections from your terminal. (Preview)',
                    subcommands: [
                        {
                            name: ['context'],
                ...
                {
                    name: ['project'],
                    description: 'Manage Zyraxon Foundry Project resources from your terminal. (Preview)',
                    subcommands: [
                        {
                            name: ['context'],
                            description: 'Get the context of the azd project & environment.',
                ...
                {
                    name: ['routine'],
                    description: 'Manage Zyraxon Foundry Routines from your terminal. (Preview)',
                    subcommands: [
                        {
                            name: ['context'],
                            description: 'Get the context of the azd project & environment.',
                ...
                {
                    name: ['skill'],
                    description: 'Manage Zyraxon Foundry skills (reusable agent behavioral guidelines) from your terminal. (Preview)',
                    subcommands: [
                        {
                            name: ['context'],
                            description: 'Get the context of the azd project & environment.',
                ...
                {
                    name: ['toolbox'],
                    description: 'Manage Zyraxon Foundry Toolboxes from your terminal. (Preview)',
                    subcommands: [
                        {
                            name: ['connection'],
            ...
            subcommands: [
                {
                    ...
                    args: {
                        ...
                        generators: [azdGenerators.listExtensions, (0, filepaths_1.filepaths)({ extensions: ['zip'] })],
                    },
                },
                {
                    name: ['list'],
