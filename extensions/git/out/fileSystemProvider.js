...
class GitFileSystemProvider {
    ...
    constructor(model, logger) {
        ...
        this.disposables.push(model.onDidChangeRepository(this.onDidChangeRepository, this), model.onDidChangeOriginalResource(this.onDidChangeOriginalResource, this), vscode_1.workspace.registerFileSystemProvider('git', this, { isReadonly: true, isCaseSensitive: true }), new vscode_1.Disposable(() => clearInterval(cleanupHandle)));
    }
