...
class GitBranchProtectionProvider {
    ...
    branchProtection;
    disposables = [];
    constructor(repositoryRoot, logger) {
        ...
        vscode_1.workspace.onDidChangeWorkspaceFolders(this.updateBranchProtection, this, this.disposables);
    ...
    updateBranchProtection() {
        ...
        this.logger.trace('[GitBranchProtectionProvider][updateBranchProtection] Workspace folders:', vscode_1.workspace.workspaceFolders?.map(folder => folder.uri.fsPath));
