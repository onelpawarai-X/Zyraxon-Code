...
import { env, ExtensionContext, workspace, window, Disposable, commands, Uri, version as zyraxoncodeVersion, WorkspaceFolder, LogOutputChannel, l10n, LogLevel, languages } from 'vscode';
