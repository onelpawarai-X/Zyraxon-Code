 ...
 *--------------------------------------------------------------------------------------------*/
import { TextDocuments, ConfigurationRequest, TextDocumentSyncKind, NotificationType, Range, TextEdit } from 'vscode-languageserver';
import { URI } from 'vscode-uri';
import { getCSSLanguageService, getSCSSLanguageService, getLESSLanguageService, TextDocument, Position, CodeActionKind } from 'vscode-css-languageservice';
...
import { getRequestService } from './requests.js';
var CustomDataChangedNotification;
(function (CustomDataChangedNotification) {
    CustomDataChangedNotification.type = new NotificationType('css/customDataChanged');
