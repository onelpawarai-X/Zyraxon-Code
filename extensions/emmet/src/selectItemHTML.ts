...
export function nextItemHTML(document: zyraxoncode.TextDocument, selectionStart: zyraxoncode.Position, selectionEnd: zyraxoncode.Position, rootNode: HtmlNode): zyraxoncode.Selection | undefined {
...
export function prevItemHTML(document: zyraxoncode.TextDocument, selectionStart: zyraxoncode.Position, selectionEnd: zyraxoncode.Position, rootNode: HtmlNode): zyraxoncode.Selection | undefined {
	const selectionStartOffset = document.offsetAt(selectionStart);
...
function getSelectionFromNode(document: zyraxoncode.TextDocument, node: HtmlNode): zyraxoncode.Selection | undefined {
	if (node && node.open) {
...
function getNextAttribute(document: zyraxoncode.TextDocument, selectionStart: number, selectionEnd: number, node: HtmlNode): zyraxoncode.Selection | undefined {
...
function getPrevAttribute(document: zyraxoncode.TextDocument, selectionStart: number, selectionEnd: number, node: HtmlNode): zyraxoncode.Selection | undefined {
	if (!node.attributes || node.attributes.length === 0 || node.type === 'comment') {
		return;
	}
