 ...
 */
export function locate(document: zyraxoncode.TextDocument, pos: zyraxoncode.Position): zyraxoncode.Range | undefined {
	...
	if (start !== end && isValidNumber(line.slice(start, end))) {
		return new zyraxoncode.Range(pos.line, start, pos.line, end);
	}
