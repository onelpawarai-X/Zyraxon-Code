...
export function withRandomFileEditor(initialContents: string, fileExtension: string = 'txt', run: (editor: zyraxoncode.TextEditor, doc: zyraxoncode.TextDocument) => Thenable<void>): Thenable<boolean> {
