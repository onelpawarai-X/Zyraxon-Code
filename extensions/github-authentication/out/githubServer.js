...
class GitHubServer {
    ...
    async login(scopes, signInProvider, extraAuthorizeParameters, existingLogin) {
        ...
        const flows = (0, flows_1.getFlows)({
            target: this._type === github_1.AuthProviderType.github
                ? 0 /* GitHubTarget.DotCom */ : supportedTarget ? 2 /* GitHubTarget.HostedEnterprise */ : 1 /* GitHubTarget.Enterprise */,
