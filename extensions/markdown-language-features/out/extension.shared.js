...
function activateShared(context, client, engine, logger, contributions) {
    ...
    const previewManager = new previewManager_1.MarkdownPreviewManager(contentProvider, logger, contributions, opener, context.workspaceState);
    ...
    context.subscriptions.push(vscode.window.registerCustomEditorProvider(markdownEditorProvider_1.MarkdownEditorProvider.viewType, new markdownEditorProvider_1.MarkdownEditorProvider(context.extensionUri, context.globalState, opener), {
