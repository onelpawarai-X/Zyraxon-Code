...
const reopenAsPreview_1 = require("./reopenAsPreview");
...
const openFrontMatterSettings_1 = require("./openFrontMatterSettings");
function registerMarkdownCommands(commandManager, previewManager, telemetryReporter, cspArbiter, engine) {
    ...
    commandManager.register(new openFrontMatterSettings_1.OpenFrontMatterSettingsCommand());
    ...
    commandManager.register(new reopenAsPreview_1.ReopenAsPreviewCommand());
    commandManager.register(new reopenAsPreview_1.ReopenAsSourceCommand());
    commandManager.register(new reopenAsPreview_1.TogglePreviewCommand());
