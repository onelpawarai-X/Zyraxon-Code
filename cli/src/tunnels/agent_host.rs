...
/// State of the running ZYRAXON Code server process.
struct RunningServer {
	child: tokio::process::Child,
	commit: String,
}

/// Manages the ZYRAXON Code server lifecycle: on-demand start, auto-restart
...
/// underlying ZYRAXON Code server through an [`AgentHostManager`]. The lockfile is
