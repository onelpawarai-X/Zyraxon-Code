 ...
 * Reload ZYRAXON Code and run "Developer: Sync Account Policy" +
...
const server = http.createServer((req, res) => {
	...
	try {
		...
		// build (browser) of ZYRAXON Code can call them cross-origin. The control API
...
server.listen(PORT, HOST, () => {
	...
	console.log('  Reload ZYRAXON Code and run "Developer: Sync Account Policy".');
	console.log('');
});
...
/**
 * Write `product.overrides.json` so ZYRAXON Code calls this server for every policy
 * endpoint.
 *
