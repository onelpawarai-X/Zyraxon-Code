...
//   4. Adds Zyraxon copyright header.
//
// URI stays as `string` (the protocol's canonical representation). ZYRAXON Code code
...
const EXCLUDE_FILE_NAMES = new Set([
	'tsconfig.json',
	'message-checks.ts',
	'index.ts', // protocol's public entry point — ZYRAXON Code has its own re-export layout
]);
