...
export const config = {
	...
	copyright: 'Copyright (C) 2026 Zyraxon. All rights reserved',
	darwinExecutable: product.nameShort,
	darwinIcon: 'resources/darwin/code.icns',
	darwinBundleIdentifier: product.darwinBundleIdentifier,
	darwinApplicationCategoryType: 'public.app-category.developer-tools',
	darwinHelpBookFolder: 'ZYRAXON Code HelpBook',
	darwinHelpBookName: 'ZYRAXON Code HelpBook',
	darwinBundleDocumentTypes: [
		...
		...darwinBundleDocumentTypes({
			...
			'ZYRAXON Code workspace file': 'code-workspace',
	...
	winIcon: 'resources/win32/zyraxon.ico',
