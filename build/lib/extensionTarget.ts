 ...
 * Mirrors the detection used in `node-vsce-sign` and the ZYRAXON Code extension management.
 */
 ...
 * marketplace target platform. Platform-specific ZYRAXON Code extensions are conventionally named
