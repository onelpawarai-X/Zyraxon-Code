...
/**
 * Platforms and architectures ZYRAXON Code actually ships. Used by Section 5 to
...
/**
 * npm `os` values for the platforms ZYRAXON Code ships, spelled the way npm package
 ...
 * host yet WILL ship on at least one platform ZYRAXON Code targets. These packages
 ...
 * extensions (js-debug, js-debug-companion, js-profile-table, ...) that ZYRAXON Code
...
/**
 * True when the arch suffix matches a platform+arch ZYRAXON Code ships.
...
async function main(): Promise<void> {
	...
	//
	// CG does this because for most repos, ZYRAXON Code extensions are dev tools --
	// not shipping code. But we ARE ZYRAXON Code. Our built-in extensions ship in
	...
	console.log('  This is a CG workaround for consumers of ZYRAXON Code extensions, but we');
	console.log('  ARE ZYRAXON Code -- our built-in extensions ship in the product.');
	console.log('=========================================================================');
	console.log('');
	...
	console.log('  this field -- it is a ZYRAXON Code custom extension.');
	console.log('=========================================================================');
	console.log('');
	...
	// ones ZYRAXON Code does not ship - deliberate, harmless over-inclusion), resolve
	...
	// ZYRAXON Code downloads them as finished VSIXs (product.json `builtInExtensions`)
