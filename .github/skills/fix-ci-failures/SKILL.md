...
### ZYRAXON Code Log Artifacts Structure
...
Common patterns in ZYRAXON Code CI:
...
2. Verify compilation: check the `ZYRAXON Code - Build` task or run `npm run typecheck-client`
