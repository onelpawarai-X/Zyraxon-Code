---
description: ZYRAXON Code coding guidelines — naming, style, types, strings, and code quality rules. Reference when writing or reviewing code.
applyTo: src/vs/**
---
...
- Include Zyraxon copyright header in all files
