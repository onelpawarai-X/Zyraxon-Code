---
description: Architecture documentation for ZYRAXON Code AI Customization view. Use when working in `src/vs/workbench/contrib/chat/browser/aiCustomization`
