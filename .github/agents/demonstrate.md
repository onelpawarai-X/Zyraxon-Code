---
name: Demonstrate
description: Agent for demonstrating ZYRAXON Code features
...
**Monaco editors (used throughout ZYRAXON Code) DO NOT work with standard Playwright methods like `.click()` on textareas or `.fill()` / `.type()`**
