---
agent: agent
description: 'Fix an unhandled error from the ZYRAXON Code error telemetry dashboard'
...
The user has given you a GitHub issue URL for an unhandled error from the ZYRAXON Code error telemetry dashboard. Fetch the issue to retrieve its details (error message, stack trace, hit count, affected users).
