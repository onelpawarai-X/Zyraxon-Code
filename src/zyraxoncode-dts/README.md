...
1. run `npx zyraxoncode-dts dev` to download the `d.ts` files into your project
1. don't forget that extension using proposed API cannot be published
1. learn more here: <__ZYRAXKEEP__0_>

## Add a new proposal

1. create a _new_ file in this directory, its name must follow this pattern `zyraxoncode.proposed.[a-zA-Z]+.d.ts`
...
1. Most likely will need to add your proposed api to zyraxoncode-api-tests as well
