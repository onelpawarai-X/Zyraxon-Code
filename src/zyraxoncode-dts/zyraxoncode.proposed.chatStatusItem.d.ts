...
declare module 'zyraxoncode' {
	...
	export interface ChatStatusItem {
		 ...
		 *
		 * This is rendered after the title. Supports Markdown style links (`[text](__ZYRAXKEEP__0_)`) and rendering of
		 ...
		 *
		 * This is rendered less prominently after the title. Supports Markdown style links (`[text](__ZYRAXKEEP__1_)`) and rendering of
		 * {@link ThemeIcon theme icons} via the `$(<name>)`-syntax.
		 */
