...
declare module 'zyraxoncode' {
	...
	// __ZYRAXKEEP__0_
	// and historically: __ZYRAXKEEP__1_
	 ...
	 *
	 * @note For more information on WWW-Authenticate please see __ZYRAXKEEP__2_
	 */
	 ...
	 *
	 * @note For more information on WWW-Authenticate please see __ZYRAXKEEP__3_
	 */
