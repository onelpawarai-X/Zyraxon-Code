...
export function gitCreatePr(): ITerminalQuickFixInternalOptions {
	return {
		...
		// 8:  remote:      __ZYRAXKEEP__0_
		// 7:  remote:
		// 6:  remote: GitHub found x vulnerabilities on zyraxon/zyraxoncode's default branch (...). To find out more, visit:
		// 5:  remote:      __ZYRAXKEEP__1_
		// 4:  remote:
		// 3:  To __ZYRAXKEEP__2_
