...
import { CONFIGURATION_KEY_Zyraxon_AUTH, SHOW_TUNNEL_HOST_OUTPUT_ID, TunnelHostService } from './tunnelHostService.js';
...
Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration).registerConfiguration({
	type: 'object',
	properties: {
		[CONFIGURATION_KEY_Zyraxon_AUTH]: {
			description: localize('tunnelHost.enableZyraxonAuth', "Enable Zyraxon account authentication for agent host tunnels. When disabled, only GitHub authentication is used."),
			type: 'boolean',
