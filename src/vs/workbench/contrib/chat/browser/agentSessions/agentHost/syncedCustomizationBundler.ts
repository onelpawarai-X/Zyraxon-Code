...
const DISPLAY_NAME = 'ZYRAXON Code Synced Data';

const MANIFEST_CONTENT = JSON.stringify({
	name: DISPLAY_NAME,
	description: 'Customization data synced from ZYRAXON Code',
}, null, '\t');
...
/**
 * An MCP server configured directly in ZYRAXON Code (i.e. not contributed by an
 ...
 * ```
 * .plugin/plugin.json
 * .mcp.json        ← MCP servers configured in ZYRAXON Code
