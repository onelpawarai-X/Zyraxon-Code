 ...
 * and in the regular ZYRAXON Code workbench window it returns nothing at all.
 */
 ...
 * any per-provider plumbing. In the regular ZYRAXON Code workbench window the
...
/**
 * Enumerates MCP servers configured directly in ZYRAXON Code — i.e. those that
 ...
 * ZYRAXON Code — are bundled into a synthetic Open Plugin.
 */
