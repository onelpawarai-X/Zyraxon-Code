...
export class ChatMcpAppModel extends Disposable {
	 ...
	 * ZYRAXON Code restarts — using {@link WebviewOriginStore} for them would
		...
		try {
			...
			switch (request.method) {
				...
				case 'ui/request-display-mode':
					// ZYRAXON Code only supports inline display mode
	 ...
	 * server-definition id is stable across ZYRAXON Code restarts. Agent-host
