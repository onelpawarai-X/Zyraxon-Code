 ...
 * that happens while ZYRAXON Code is closed can still be surfaced on next launch.
 */
...
export class ChatStatusBarEntry extends Disposable implements IWorkbenchContribution {
	...
	private initializeQuotaResumeState(): void {
		if (this.quotaResumeState === 'blocked') {
			...
			// quota data whether the limit has since reset while ZYRAXON Code was closed.
