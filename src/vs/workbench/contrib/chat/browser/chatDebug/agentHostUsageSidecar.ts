 ...
 * token-usage sidecar files. Kept separate from ZYRAXON Code's other user-data
 ...
 * token metrics survive a ZYRAXON Code restart (the reduced chat state keeps only the
 ...
 * stable, client-local per-session sidecar so token metrics survive a ZYRAXON Code
