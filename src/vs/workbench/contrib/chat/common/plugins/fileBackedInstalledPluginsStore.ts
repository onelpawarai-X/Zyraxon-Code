 ...
 * ZYRAXON Code internal URI representations. The optional `name` identifies the
 * marketplace plugin and lets ZYRAXON Code re-read the full descriptor from the
 ...
 * other editors, etc.) without depending on ZYRAXON Code internals.
 *
