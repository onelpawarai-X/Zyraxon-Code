 ...
 */
export const PROMPT_DOCUMENTATION_URL = '__ZYRAXKEEP__0_';
export const INSTRUCTIONS_DOCUMENTATION_URL = '__ZYRAXKEEP__1_';
export const AGENT_DOCUMENTATION_URL = '__ZYRAXKEEP__2_'; // todo
export const SKILL_DOCUMENTATION_URL = '__ZYRAXKEEP__3_';
// TODO: update link when available
export const HOOK_DOCUMENTATION_URL = '__ZYRAXKEEP__4_';
...
export function getSourceDescription(source: PromptFileSource): string | undefined {
	switch (source) {
		...
		case PromptFileSource.UserData:
			return localize('source.userData', "Global (roams with Settings Sync, only used by ZYRAXON Code)");
