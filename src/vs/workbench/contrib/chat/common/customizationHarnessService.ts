 ...
 *
 * The default (core) registration exposes a single "ZYRAXON Code" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * ZYRAXON Code harness falls back to the core prompts service.
	 *
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default ZYRAXON Code harness falls back to the core prompts service.
	 *
	 * @param sessionResource URI of the chat session whose customizations
