	...
	constructor(
		...
		this.hostContext = derived((reader): McpApps.McpUiHostContext => {
			return {
				...
				styles: {
					variables: {
						'--color-background-primary': 'var(--zyraxoncode-editor-background)',
						'--color-background-secondary': 'var(--zyraxoncode-sideBar-background)',
						'--color-background-tertiary': 'var(--zyraxoncode-activityBar-background)',
						'--color-background-inverse': 'var(--zyraxoncode-editor-foreground)',
						'--color-background-ghost': 'transparent',
						'--color-background-info': 'var(--zyraxoncode-inputValidation-infoBackground)',
						'--color-background-danger': 'var(--zyraxoncode-inputValidation-errorBackground)',
						'--color-background-success': 'var(--zyraxoncode-diffEditor-insertedTextBackground)',
						'--color-background-warning': 'var(--zyraxoncode-inputValidation-warningBackground)',
						'--color-background-disabled': 'var(--zyraxoncode-editor-inactiveSelectionBackground)',

						'--color-text-primary': 'var(--zyraxoncode-foreground)',
						'--color-text-secondary': 'var(--zyraxoncode-descriptionForeground)',
						'--color-text-tertiary': 'var(--zyraxoncode-disabledForeground)',
						'--color-text-inverse': 'var(--zyraxoncode-editor-background)',
						'--color-text-info': 'var(--zyraxoncode-textLink-foreground)',
						'--color-text-danger': 'var(--zyraxoncode-errorForeground)',
						'--color-text-success': 'var(--zyraxoncode-testing-iconPassed)',
						'--color-text-warning': 'var(--zyraxoncode-editorWarning-foreground)',
						'--color-text-disabled': 'var(--zyraxoncode-disabledForeground)',
						'--color-text-ghost': 'var(--zyraxoncode-descriptionForeground)',

						'--color-border-primary': 'var(--zyraxoncode-widget-border)',
						'--color-border-secondary': 'var(--zyraxoncode-editorWidget-border)',
						'--color-border-tertiary': 'var(--zyraxoncode-panel-border)',
						'--color-border-inverse': 'var(--zyraxoncode-foreground)',
						'--color-border-ghost': 'transparent',
						'--color-border-info': 'var(--zyraxoncode-inputValidation-infoBorder)',
						'--color-border-danger': 'var(--zyraxoncode-inputValidation-errorBorder)',
						'--color-border-success': 'var(--zyraxoncode-testing-iconPassed)',
						'--color-border-warning': 'var(--zyraxoncode-inputValidation-warningBorder)',
						'--color-border-disabled': 'var(--zyraxoncode-disabledForeground)',

						'--color-ring-primary': 'var(--zyraxoncode-focusBorder)',
						'--color-ring-secondary': 'var(--zyraxoncode-focusBorder)',
						'--color-ring-inverse': 'var(--zyraxoncode-focusBorder)',
						'--color-ring-info': 'var(--zyraxoncode-inputValidation-infoBorder)',
						'--color-ring-danger': 'var(--zyraxoncode-inputValidation-errorBorder)',
						'--color-ring-success': 'var(--zyraxoncode-testing-iconPassed)',
						'--color-ring-warning': 'var(--zyraxoncode-inputValidation-warningBorder)',

						'--font-sans': 'var(--zyraxoncode-font-family)',
						'--font-mono': 'var(--zyraxoncode-editor-font-family)',
						...
						'--shadow-hairline': '0 0 0 1px var(--zyraxoncode-widget-shadow)',
						'--shadow-sm': '0 1px 2px 0 var(--zyraxoncode-widget-shadow)',
						'--shadow-md': '0 4px 6px -1px var(--zyraxoncode-widget-shadow)',
						'--shadow-lg': '0 10px 15px -3px var(--zyraxoncode-widget-shadow)',
					}
				},
				displayMode: 'inline',
