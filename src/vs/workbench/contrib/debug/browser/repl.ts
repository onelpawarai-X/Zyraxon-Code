...
export class Repl extends FilterViewPane implements IHistoryNavigationWidget {
	...
	private onDidStyleChange(): void {
		...
		if (this.styleElement) {
			...
			this.container.style.setProperty(`--zyraxoncode-repl-font-family`, cssFontFamily);
			this.container.style.setProperty(`--zyraxoncode-repl-font-size`, `${this.replOptions.replConfiguration.fontSize}px`);
			this.container.style.setProperty(`--zyraxoncode-repl-font-size-for-twistie`, `${this.replOptions.replConfiguration.fontSizeForTwistie}px`);
			this.container.style.setProperty(`--zyraxoncode-repl-line-height`, this.replOptions.replConfiguration.cssLineHeight);
