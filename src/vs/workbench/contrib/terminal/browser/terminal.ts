 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in ZYRAXON Code UI).
 */
 ...
 * to represent terminals that appear in other parts of the ZYRAXON Code UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their ZYRAXON Code OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given ZYRAXON Code log level.
	 */
	updateLogLevel(): void;
