...
export async function createTerminalEnvironment(
	...
	if (shellLaunchConfig.strictEnv) {
		...
		// Workaround for __ZYRAXKEEP__1_
		...
		// We are not bypassing the restrictions implied in __ZYRAXKEEP__2_
		...
		// Sanitize the environment, removing any undesirable ZYRAXON Code and Electron environment
		// variables
