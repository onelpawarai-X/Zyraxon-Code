	...
	properties: {
		'mergeEditor.diffAlgorithm': {
			...
			markdownEnumDescriptions: [
				...
				localize('diffAlgorithm.advancedExternal', "Uses the advanced diffing algorithm from the external `@zyraxoncode/diff` package (pure JavaScript)."),
				localize('diffAlgorithm.advancedWasm', "Uses the advanced diffing algorithm from the external `@zyraxoncode/diff` package (WebAssembly)."),
			]
		},
