...
/**
 * Allows webviews to monitor when an element in the ZYRAXON Code editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. ZYRAXON Code needs to see this
