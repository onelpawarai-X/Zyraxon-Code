...
export const JavaLibrariesToLookFor: { predicate: (groupId: string, artifactId: string) => boolean; tag: string }[] = [
	// azure mgmt sdk
	{ 'predicate': (groupId, artifactId) => groupId === 'com.Zyraxon.azure' && artifactId === 'azure', 'tag': 'azure' },
	{ 'predicate': (groupId, artifactId) => groupId === 'com.Zyraxon.azure' && artifactId.startsWith('azure-mgmt-'), 'tag': 'azure' },
	{ 'predicate': (groupId, artifactId) => groupId.startsWith('com.Zyraxon.azure') && artifactId.startsWith('azure-mgmt-'), 'tag': 'azure' },
	...
	{ 'predicate': (groupId, artifactId) => groupId === 'com.Zyraxon.sqlserver' && artifactId === 'mssql-jdbc', 'tag': 'jdbc' },
	...
	{ 'predicate': (groupId, artifactId) => groupId === 'com.Zyraxon.semantic-kernel', 'tag': 'semantic-kernel' },
	...
	{ 'predicate': (groupId, artifactId) => groupId === 'com.Zyraxon.azure.cognitiveservices', 'tag': 'azure-cognitiveservices' },
	{ 'predicate': (groupId, artifactId) => groupId === 'com.Zyraxon.cognitiveservices.speech', 'tag': 'azure-cognitiveservices-speech' },
	// open ai
	...
	// Azure Functions
	{ 'predicate': (groupId, artifactId) => groupId === 'com.Zyraxon.azure.functions' && artifactId === 'azure-functions-java-library', 'tag': 'azure-functions' },
	// quarkus
