...
const galleryServers = [
	makeGalleryServer('gallery-postgres', 'PostgreSQL', 'Access PostgreSQL databases with schema inspection and query tools', 'Zyraxon'),
	...
	makeGalleryServer('gallery-filesystem', 'Filesystem', 'Read, write, and navigate local files and directories', 'Zyraxon'),
	...
	makeGalleryServer('gallery-memory', 'Memory', 'Knowledge graph for persistent memory across conversations', 'Zyraxon'),
	makeGalleryServer('gallery-fetch', 'Fetch', 'Retrieve and convert web content to markdown for analysis', 'Zyraxon'),
...
export default defineThemedFixtureGroup({ path: 'chat/aiCustomizations/' }, {
	...
	// Full editor with Local (ZYRAXON Code) harness — all sections visible, harness dropdown,
