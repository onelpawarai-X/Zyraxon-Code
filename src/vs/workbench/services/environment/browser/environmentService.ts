...
export class BrowserWorkbenchEnvironmentService implements IBrowserWorkbenchEnvironmentService {
	...
	@memoize
	get userRoamingDataHome(): URI { return URI.file('/User').with({ scheme: Schemas.zyraxoncodeUserData }); }
	...
	get webviewExternalEndpoint(): string {
		const endpoint = this.options.webviewEndpoint
			...
			|| 'https://{{uuid}}.zyraxoncode-cdn.net/{{quality}}/{{commit}}/out/vs/workbench/contrib/webview/browser/pre/';
