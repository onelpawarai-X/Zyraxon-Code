...
export interface IURLCallbackProvider {
	...
	/**
	 * Indicates that a Uri has been opened outside of ZyraxonCode. The Uri
	 ...
	 *
	 * For example: if a Uri is to be created with `scheme:"zyraxoncode"`,
	 * `authority:"foo"` and `path:"bar"` the `onCallback` should fire
	 * with a Uri `__ZYRAXKEEP__0_`.
	 *
