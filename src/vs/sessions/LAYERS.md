...
The sessions layer sits above `vs/workbench` in the ZYRAXON Code source code hierarchy. For the broader ZYRAXON Code layer rules (base → platform → editor → workbench → sessions), see `.github/instructions/source-code-organization.instructions.md`.
