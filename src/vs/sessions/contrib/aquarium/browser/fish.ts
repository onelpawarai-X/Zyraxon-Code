...
/** The three ZYRAXON Code release channel colors used as fish "species". */
 ...
 * a single `<symbol>` containing the ZYRAXON Code logo path. All fish reference
 ...
 *   - ZYRAXON Code logo body, sliced into N vertical strips that each oscillate in
...
function buildFishSvg(targetDocument: Document): SVGSVGElement {
	...
	// viewBox 0..96 matches the original ZYRAXON Code icon.
