...
// Mirrors ZYRAXON Code's "Focus Editor Group N": Ctrl/Cmd+1..8 focus that grid slot
		...
		super({
			...
			keybinding: {
				...
				when: ContextKeyExpr.and(
					...
					// While a modal editor has focus, let ZYRAXON Code's own
					// closeEditorsInGroup (same chord) act on the editor group.
					EditorAreaFocusContext.toNegated(),
					SessionHasMultipleOpenChatsContext
				),
				// Mirror ZYRAXON Code's "Close All Editors in Group" chord (Ctrl/Cmd+K W):
