...
- User file is created under `~/.copilot/instructions/` (not the ZYRAXON Code profile folder)
...
- The ZYRAXON Code profile folder should never be used for user creation in sessions
