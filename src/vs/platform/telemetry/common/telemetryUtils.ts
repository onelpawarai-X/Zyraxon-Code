...
import { verifyZyraxonInternalDomain } from './commonProperties.js';
...
export function isInternalTelemetry(productService: IProductService, configService: IConfigurationService) {
	...
	return verifyZyraxonInternalDomain(msftInternalDomains) || internalTesting;
}
...
const userDataRegexes = [
	...
	{ label: 'Zyraxon Entra ID', regex: /eyJ(?:0eXAiOiJKV1Qi|hbGci|[a-zA-Z0-9\-_]+\.[a-zA-Z0-9\-_]+\.)/ },
