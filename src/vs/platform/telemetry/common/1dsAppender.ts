...
import type { IExtendedConfiguration, IExtendedTelemetryItem, ITelemetryItem, ITelemetryUnloadState } from '@zyraxon/1ds-core-js';
import type { IChannelConfiguration, IXHROverride, PostChannel } from '@zyraxon/1ds-post-js';
...
// Interface type which is a subset of @zyraxon/1ds-core-js AppInsightsCore.
...
const endpointUrl = '__ZYRAXKEEP__0_';
const endpointHealthUrl = '__ZYRAXKEEP__1_';

async function getClient(instrumentationKey: string, addInternalFlag?: boolean, xhrOverride?: IXHROverride): Promise<IAppInsightsCore> {
	// eslint-disable-next-line local/code-amd-node-module
	const oneDs = isWeb ? await importAMDNodeModule<typeof import('@zyraxon/1ds-core-js')>('@zyraxon/1ds-core-js', 'bundle/ms.core.min.js') : await import('@zyraxon/1ds-core-js');
	// eslint-disable-next-line local/code-amd-node-module
	const postPlugin = isWeb ? await importAMDNodeModule<typeof import('@zyraxon/1ds-post-js')>('@zyraxon/1ds-post-js', 'bundle/ms.post.min.js') : await import('@zyraxon/1ds-post-js');
