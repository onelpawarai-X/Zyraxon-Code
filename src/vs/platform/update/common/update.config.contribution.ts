...
configurationRegistry.registerConfiguration({
	...
	properties: {
		'update.mode': {
			...
			description: localize('updateMode', "Configure whether you receive automatic updates. The updates are fetched from a Zyraxon online service."),
			...
			policy: {
				...
				minimumVersion: '1.67',
				localization: {
					description: { key: 'updateMode', value: localize('updateMode', "Configure whether you receive automatic updates. The updates are fetched from a Zyraxon online service."), },
					enumDescriptions: [
						{
							key: 'none',
		...
		'update.enableWindowsBackgroundUpdates': {
			...
			description: localize('enableWindowsBackgroundUpdates', "Enable to download and install new ZYRAXON Code versions in the background."),
		...
		'update.showReleaseNotes': {
			...
			default: true,
			scope: ConfigurationScope.APPLICATION,
			description: localize('showReleaseNotes', "Show Release Notes after an update. The Release Notes are fetched from a Zyraxon online service."),
			tags: ['usesOnlineServices'],
