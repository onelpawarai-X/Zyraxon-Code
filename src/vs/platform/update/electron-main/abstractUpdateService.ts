...
export type UpdateErrorClassification = {
	...
	comment: 'This is used to know how often ZYRAXON Code updates have failed.';
};
...
export abstract class AbstractUpdateService extends Disposable implements IUpdateService {
	...
	private async trackVersionChange(): Promise<void> {
		...
		type VersionChangeClassification = {
			owner: 'dmitriv';
			comment: 'Fired when ZYRAXON Code detects a version change on startup.';
			fromVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The previous version of ZYRAXON Code.' };
			...
			toVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The current version of ZYRAXON Code.' };
