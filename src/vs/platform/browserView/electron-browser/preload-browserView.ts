...
class ElementPicker {
	...
	private static readonly _CURSOR_DEFAULT = '/* ZYRAXON Code injected style */ * { cursor: default !important; }';
	private static readonly _CURSOR_CROSSHAIR = '/* ZYRAXON Code injected style */ * { cursor: crosshair !important; }';
