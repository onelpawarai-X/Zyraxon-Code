...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit ZYRAXON Code's "shell environment" that may
	 ...
	 * a terminal used to drive some ZYRAXON Code feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to ZYRAXON Code and extensions
	 */
