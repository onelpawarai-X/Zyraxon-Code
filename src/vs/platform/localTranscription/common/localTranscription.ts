 ...
 * Zyraxon's Foundry Local streaming ASR engine (onnxruntime + onnxruntime-genai
...
export interface ILocalTranscriptionService {
	 ...
	 * runtime (Foundry Local addon + core libraries) is downloaded from ZYRAXON Code's
