...
export class RemoteTunnelService extends Disposable implements IRemoteTunnelService {
	...
	private getTunnelCommandLocation() {
		if (!this._tunnelCommand) {
			...
			if (isMacintosh) {
				// appRoot = /Applications/ZYRAXON ZYRAXON Code.app/Contents/Resources/app
				// bin = /Applications/ZYRAXON ZYRAXON Code.app/Contents/Resources/app/bin
				...
				if (this.productService.win32VersionedUpdate) {
					...
					// bin = C:\Users\<name>\AppData\Local\Programs\Zyraxon ZYRAXON Code Insiders\bin
