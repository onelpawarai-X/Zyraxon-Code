...
export class AgentHostStateManager extends Disposable {
	 ...
	 * onto a per-chat channel. ZYRAXON Code currently models every session as
	 ...
	 * the session's single chat. ZYRAXON Code models every session as having
	 ...
	 * dispatching this action; for ZYRAXON Code-internal clients that happens
	 ...
	 * activity status) onto the chat channel. To preserve ZYRAXON Code's
