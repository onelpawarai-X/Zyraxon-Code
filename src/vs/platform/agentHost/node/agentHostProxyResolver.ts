 ...
 * CAPI proxy through ZYRAXON Code's Electron session before spawning the Copilot SDK.
 *
	...
	private _getProxyResolver(): ReturnType<typeof createProxyResolver> {
		if (!this._proxyResolver) {
			...
			const params: ProxyAgentParams = {
				// The host proxy resolution runs in ZYRAXON Code: reverse-call a connected
