 ...
 * Copilot SDK event log from ZYRAXON Code turns.
 */
...
/**
 * Translates a sequence of ZYRAXON Code {@link Turn}s into a Copilot SDK
 ...
 * {@link serializeSessionEventsToJsonl}: turns the given ZYRAXON Code turns directly
