...
/* __GDPR__FRAGMENT__
	"CopilotCliForwardedTelemetry": {
		...
		"is_staff": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Whether the user is a GitHub or Zyraxon staff member.", "isMeasurement": true },
 ...
 * Zyraxon cluster/database as the rest of the agent host's telemetry.
 *
