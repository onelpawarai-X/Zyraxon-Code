...
- [ ] Zyraxon copyright header is on every new file.
...
- [ ] `ZYRAXON Code - Build` task shows zero TypeScript errors. If task is unavailable, `npm run typecheck-client` exits 0.
