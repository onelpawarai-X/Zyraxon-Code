...
export async function buildOptions(
	...
	const settingsEnv: Record<string, string> = {
		...
		// Attribute the CLI's tool subprocesses (`gh`, …) to ZYRAXON Code.
		...
		// tool, so commands from that tool are not attributed to ZYRAXON Code.
 ...
 * proxied env still announces the originating ZYRAXON Code surface. Mirror of the
