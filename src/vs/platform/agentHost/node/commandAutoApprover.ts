...
export interface IShouldAutoApproveOptions {
	...
	/**
	 * Effective ZYRAXON Code `chat.tools.terminal.autoApprove` rules forwarded from
 ...
 * The rules are normally forwarded from ZYRAXON Code's
...
// ---- Default rules ----------------------------------------------------------
//
// Compatibility fallback for clients that do not forward the ZYRAXON Code
