...
// This file adds ZYRAXON Code-specific additions (ISetAuthTokenParams, ProtocolError)
...
/**
 * ZYRAXON Code-specific extension: set the auth token on the server.
