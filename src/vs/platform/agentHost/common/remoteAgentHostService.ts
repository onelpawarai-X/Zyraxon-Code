...
export interface IRemoteAgentHostSSHConnection {
	 ...
	 * ZYRAXON Code Remote SSH authority.
	 */
	 ...
	 * client connects to, and is used to construct the ZYRAXON Code Remote
...
export interface IRemoteAgentHostTunnelConnection {
	 ...
	 * Used as the tunnel name in the ZYRAXON Code Remote Tunnels authority
