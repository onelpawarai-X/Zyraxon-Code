...
export interface IToolCallMeta {
	/**
	 * ZYRAXON Code rendering hint. `terminal` routes the call to the command/output
...
/**
 * The set of ZYRAXON Code-recognized tool-call rendering kinds. Add a new value here
