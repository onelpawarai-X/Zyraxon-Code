...
type AgentHostProcessErrorClassification = {
	...
	willRestart: { classification: 'SystemMetaData'; purpose: 'PerformanceAndHealth'; isMeasurement: true; comment: 'Whether ZYRAXON Code will attempt to restart the agent host after this failure.' };
