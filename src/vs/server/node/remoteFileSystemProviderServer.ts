...
export class RemoteAgentFileSystemProviderChannel extends AbstractDiskFileSystemProviderChannel<RemoteAgentConnectionContext> {
	...
	protected override transformIncoming(uriTransformer: IURITransformer, _resource: UriComponents, supportZyraxonCodeResource = false): URI {
		if (supportZyraxonCodeResource && _resource.path === '/zyraxoncode-resource' && _resource.query) {
