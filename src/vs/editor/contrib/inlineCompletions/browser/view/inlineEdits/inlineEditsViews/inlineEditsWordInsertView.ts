				...
				return [
					n.div({
						style: {
							...
							background: 'var(--zyraxoncode-editor-background)'
						}
					}, []),
					n.div({
						style: {
							...
							padding: '0px',
							textAlign: 'center',
							background: 'var(--zyraxoncode-inlineEdit-modifiedChangedTextBackground)',
					...
					n.div({
						style: {
							...
							background: 'var(--zyraxoncode-inlineEdit-wordReplacementView-background)',
						}
					}, []),
					n.svg({
						viewBox: '0 0 12 18',
						...
						n.svgElem('path', {
							...
							fill: 'var(--zyraxoncode-inlineEdit-modifiedChangedTextBackground)',
						})
					])
				];
			})
