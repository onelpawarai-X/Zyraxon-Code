...
const SHADOW_ROOT_CSS = /* css */ `
	...
	:host-context(.windows:lang(zh-Hans)) { font-family: "Segoe WPC", "Segoe UI", "Zyraxon YaHei", sans-serif; }
	:host-context(.windows:lang(zh-Hant)) { font-family: "Segoe WPC", "Segoe UI", "Zyraxon Jhenghei", sans-serif; }
