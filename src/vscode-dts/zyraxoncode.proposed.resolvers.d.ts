...
declare module 'zyraxoncode' {
	...
	export interface RemoteAuthorityResolver {
		/**
		 * Resolve the authority part of the current opened `zyraxoncode-remote://` URI.
		 *
		 * This method will be invoked once during the startup of the editor and again each time
		 * the editor detects a disconnection.
		 *
		 * @param authority The authority part of the current opened `zyraxoncode-remote://` URI.
		...
		/**
		 * Get the canonical URI (if applicable) for a `zyraxoncode-remote://` URI.
		 *
	...
	export namespace env {
		...
		/**
		 * The authority part of the current opened `zyraxoncode-remote://` URI.
