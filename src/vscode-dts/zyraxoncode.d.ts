...
declare module 'zyraxoncode' {
	...
	export interface TextDocument {
		 ...
		 *
		 * @param position A position.
		 * @returns A valid zero-based offset in UTF-16 [code units](__ZYRAXKEEP__0_).
		 */
		 ...
		 *
		 * @param offset A zero-based offset into the document. This offset is in UTF-16 [code units](__ZYRAXKEEP__1_).
	...
	export class Position {
		 ...
		 *
		 * Character offsets are expressed using UTF-16 [code units](__ZYRAXKEEP__2_).
		 */
	...
	/**
	 * A reference to one of the workbench colors as defined in __ZYRAXKEEP__3_
	...
	export class ThemeColor {
		 ...
		 * @param id of the color. The available colors are listed in __ZYRAXKEEP__4_
		 */
	 ...
	 * and [ThemeIcon ids](__ZYRAXKEEP__5_) are supported.
	...
	export class ThemeIcon {
		...
		/**
		 * The id of the icon. The available icons are listed in __ZYRAXKEEP__6_
		 */
		readonly id: string;
		 ...
		 * @param id id of the icon. The available icons are listed in __ZYRAXKEEP__7_
	...
	export interface ThemableDecorationRenderOptions {
		 ...
		 * For further information: __ZYRAXKEEP__8_(v=vs.85).aspx
		 */
	...
	export class Uri {
		...
		/**
		 * Create an URI from a string, e.g. `__ZYRAXKEEP__9_`,
		 * `__ZYRAXKEEP__10_`, or `scheme:with/path`.
		 *
		 ...
		 * so that is true: `joinPath(Uri.file('__ZYRAXKEEP__11_'), '../../other').fsPath === 'c:/other'`
		 *
		...
		/**
		 * Scheme is the `http` part of `__ZYRAXKEEP__12_`.
		 * The part before the first colon.
		 */
		readonly scheme: string;

		/**
		 * Authority is the `__ZYRAXKEEP__13_` part of `__ZYRAXKEEP__14_`.
		 * The part between the first double slashes and the next slash.
		 */
		readonly authority: string;

		/**
		 * Path is the `/some/path` part of `__ZYRAXKEEP__15_`.
		 */
		readonly path: string;

		/**
		 * Query is the `query` part of `__ZYRAXKEEP__16_`.
		 */
		readonly query: string;

		/**
		 * Fragment is the `fragment` part of `__ZYRAXKEEP__17_`.
		 */
		readonly fragment: string;
		 ...
		 * ```ts
		 * const u = URI.parse('__ZYRAXKEEP__18_')
		 * u.authority === 'server'
	...
	export class RelativePattern {
		 ...
		 *   const pattern1 = new zyraxoncode.RelativePattern(folder, '*.ts');
		 *
		 *   // Match any TypeScript file in `someFolder` inside this workspace folder
		 *   const pattern2 = new zyraxoncode.RelativePattern(folder, 'someFolder/*.ts');
		 * }
		 * ```
		 *
	...
	export class CodeActionKind {
		 ...
		 * normal [lightbulb](__ZYRAXKEEP__19_) menu. Source actions
	...
	export interface CodeActionContext {
		 ...
		 *
		 * Actions not of this kind are filtered out before being shown by the [lightbulb](__ZYRAXKEEP__20_).
		 */
	...
	export class CodeAction {
		 ...
		 *
		 * - Disabled code actions are not shown in automatic [lightbulb](__ZYRAXKEEP__21_)
		 * code action menu.
		 *
		 * - Disabled actions are shown as faded out in the code action menu when the user request a more specific type
		 * of code action, such as refactorings.
		 *
		 * - If the user has a [keybinding](__ZYRAXKEEP__22_)
	 ...
	 *
	 * - The [lightbulb](__ZYRAXKEEP__23_) feature, which shows
	 ...
	 * the [go to definition](__ZYRAXKEEP__24_)
	...
	/**
	 * Human-readable text that supports formatting via the [markdown syntax](__ZYRAXKEEP__25_).
	 *
	...
	export class MarkdownString {
		 ...
		 * and attributes to be rendered. See __ZYRAXKEEP__26_
		 ...
		 *
		 * ```ts
		 * const md = new zyraxoncode.MarkdownString(`[link](./file.js)`);
		 * md.baseUri = zyraxoncode.Uri.file('/path/to/dir/');
		 ...
		 * ```ts
		 * const md = new zyraxoncode.MarkdownString(`[link](./file.js)`);
		 * md.baseUri = zyraxoncode.Uri.file('/path/to/otherFile.js');
	 ...
	 * the [hover](__ZYRAXKEEP__27_)-feature.
	 */
	 ...
	 * the [go to symbol](__ZYRAXKEEP__28_)-feature.
	 */
	 ...
	 * the [symbol search](__ZYRAXKEEP__29_)-feature.
	 */
	 ...
	 * the [find references](__ZYRAXKEEP__30_)-feature.
	 */
	 ...
	 * [the full snippet syntax](__ZYRAXKEEP__31_).
	 */
	 ...
	 * the [rename](__ZYRAXKEEP__32_)-feature.
	 */
	 ...
	 * the [parameter hints](__ZYRAXKEEP__33_)-feature.
	 */
	 ...
	 * [Folding](__ZYRAXKEEP__35_) in the editor.
	 */
	 ...
	 * const config = workspace.getConfiguration('launch', zyraxoncode.workspace.workspaceFolders[0].uri);
	 *
	 * // retrieve values
	 * const values = config.get('configurations');
	 * ```
	 *
	 * Refer to [Settings](__ZYRAXKEEP__36_) for more information.
	 */
	...
	export interface DiagnosticCollection extends Iterable<[uri: Uri, diagnostics: readonly Diagnostic[]]> {
		 ...
		 * name when defining [problem matchers](__ZYRAXKEEP__37_).
		 */
	...
	export interface LanguageStatusItem {
		 ...
		 *
		 * Where the icon-name is taken from the ThemeIcon [icon set](__ZYRAXKEEP__38_), e.g.
	...
	export interface AccessibilityInformation {
		 ...
		 * More about aria roles can be found here __ZYRAXKEEP__39_
		 */
	...
	export interface StatusBarItem {
		 ...
		 * `My text $(icon-name) contains icons like $(icon-name) this one.`
		 *
		 * Where the icon-name is taken from the ThemeIcon [icon set](__ZYRAXKEEP__40_), e.g.
		 * `light-bulb`, `thumbsup`, `zap` etc.
		 */
		text: string;
	...
	export interface Terminal {
		 ...
		 *   	zyraxoncode.window.showInformationMessage(`Exit code: ${t.exitStatus.code}`);
		 *   }
		 * });
		 * ```
		 */
		...
		/**
		 * An object that contains [shell integration](__ZYRAXKEEP__41_)-powered
	...
	/**
	 * [Shell integration](__ZYRAXKEEP__43_)-powered capabilities owned by a terminal.
	 */
	export interface TerminalShellIntegration {
		 ...
		 * Execute a command, sending ^C as necessary to interrupt any running command if needed.
		 *
		 * *Note* This is not guaranteed to work as [shell integration](__ZYRAXKEEP__44_)
	...
	export interface ExtensionContext {
		 ...
		 * {@linkcode ExtensionContext.extensionUri extensionUri}, e.g. `zyraxoncode.Uri.joinPath(context.extensionUri, relativePath);`
		 *
	 ...
	 * a file or folder doesn't exist, use them like so: `throw zyraxoncode.FileSystemError.FileNotFound(someUri);`
	 */
	...
	export interface WebviewOptions {
		 ...
		 *
		 * *Note* that port mappings only work for `http` or `https` urls. Websocket urls (e.g. `__ZYRAXKEEP__45_`)
	...
	export interface Webview {
		 ...
		 * ```html
		 * <script>
		 *     const zyraxoncode = acquireVsCodeApi(); // acquireVsCodeApi can only be invoked once
		 *     zyraxoncode.postMessage({ message: 'hello!' });
		 * </script>
		 * ```
		 *
		 ...
		 * setting a [content security policy](__ZYRAXKEEP__46_).
		 */
		html: string;
		 ...
		 *
		 *   For older versions of zyraxoncode, if an `ArrayBuffer` is included in `message`,
		 ...
		 *
		 *   However if your extension targets zyraxoncode 1.57+ in the `engines` field of its
		 ...
		 *
		 * ```ts
		 * webview.html = `<img src="${webview.asWebviewUri(zyraxoncode.Uri.file('/Users/codey/workspace/cat.gif'))}">`
		 * ```
		 */
	...
	/**
	 * Restore webview panels that have been persisted when zyraxoncode shuts down.
	 *
	 ...
	 *
	 * // Get existing state
	 * const oldState = zyraxoncode.getState() || { value: 0 };
	 *
	 * // Update state
	...
	export namespace env {
		...
		/**
		 * The application name of the editor, like 'ZYRAXON Code'.
		 */
		 ...
		 *
		 * Learn more about [Portable Mode](__ZYRAXKEEP__47_).
		 */
		 ...
		 * * ZyraxonCode itself (`zyraxoncode:` from `zyraxoncode.env.uriScheme`)
		 *
		 ...
		 * ```typescript
		 * zyraxoncode.window.registerUriHandler({
		 *   handleUri(uri: zyraxoncode.Uri): zyraxoncode.ProviderResult<void> {
		 ...
		 * });
		 *
		 * const callableUri = await zyraxoncode.env.asExternalUri(zyraxoncode.Uri.parse(zyraxoncode.env.uriScheme + ':__ZYRAXKEEP__48_'));
		 * await zyraxoncode.env.openExternal(callableUri);
		 * ```
		 *
	 ...
	 * the [command palette](__ZYRAXKEEP__49_).
	 * * keybinding - Use the `keybindings`-section in `package.json` to enable
	 * [keybindings](__ZYRAXKEEP__50_)
	 * for your extension.
	 *
	...
	export namespace window {
		 ...
		 * [shell integration](__ZYRAXKEEP__51_) is
		 ...
		 * [shell integration](__ZYRAXKEEP__52_) is
		 * activated for the terminal.
		 */
		 ...
		 * [command-line format](__ZYRAXKEEP__53_).
		 ...
		 * the following rules:
		 *
		 * - The uri-scheme must be `zyraxoncode.env.uriScheme`;
		 * - The uri-authority must be the extension id (e.g. `my.extension`);
		 * - The uri-path, -query and -fragment parts are arbitrary.
		 *
		 * For example, if the `my.extension` extension registers a uri handler, it will only
		 * be allowed to handle uris with the prefix `__ZYRAXKEEP__54_`.
		 *
	...
	export class TreeItem {
		 ...
		 *
		 * Please use `zyraxoncode.open` or `zyraxoncode.diff` as command IDs when the tree item is opening
	...
	export interface TerminalOptions {
		 ...
		 * specifying shell args in [command-line format](__ZYRAXKEEP__55_).
		 */
		 ...
		 * via the [shell integration command decoration](__ZYRAXKEEP__56_).
		 *
		 * This should be used if the terminal includes [custom shell integration support](__ZYRAXKEEP__57_).
	...
	export interface ExtensionTerminalOptions {
		 ...
		 * An example impact of UX of this is if the command line is reported with a nonce, it will
		 * not need to verify with the user that the command line is correct before rerunning it
		 * via the [shell integration command decoration](__ZYRAXKEEP__58_).
		 *
		 * This should be used if the terminal includes [custom shell integration support](__ZYRAXKEEP__59_).
	...
	export interface Pseudoterminal {
		 ...
		 * ```typescript
		 * const writeEmitter = new zyraxoncode.EventEmitter<string>();
		 * const pty: zyraxoncode.Pseudoterminal = {
		 *   onDidWrite: writeEmitter.event,
		 *   open: () => writeEmitter.fire('\x1b[31mHello world\x1b[0m'),
		 *   close: () => {}
		 * };
		 * zyraxoncode.window.createTerminal({ name: 'My terminal', pty });
		 * ```
		 *
		 ...
		 * ```typescript
		 * const dimensionsEmitter = new zyraxoncode.EventEmitter<zyraxoncode.TerminalDimensions>();
		 * const pty: zyraxoncode.Pseudoterminal = {
		 *   onDidWrite: writeEmitter.event,
		 ...
		 * ```typescript
		 * const writeEmitter = new zyraxoncode.EventEmitter<string>();
		 * const closeEmitter = new zyraxoncode.EventEmitter<void>();
		 * const pty: zyraxoncode.Pseudoterminal = {
		 *   onDidWrite: writeEmitter.event,
		 ...
		 *   handleInput: data => {
		 *     if (data !== 'y') {
		 *       zyraxoncode.window.showInformationMessage('Something went wrong');
		 *     }
		 *     closeEmitter.fire();
		 *   }
		 * };
		 * const terminal = zyraxoncode.window.createTerminal({ name: 'Exit example', pty });
		 * terminal.show(true);
		 * ```
		 */
		 ...
		 * ```typescript
		 * const writeEmitter = new zyraxoncode.EventEmitter<string>();
		 * const changeNameEmitter = new zyraxoncode.EventEmitter<string>();
		 * const pty: zyraxoncode.Pseudoterminal = {
		 *   onDidWrite: writeEmitter.event,
		 ...
		 * };
		 * zyraxoncode.window.createTerminal({ name: 'Local echo', pty });
		 * ```
		 */
	...
	export interface WorkspaceFolder {
		 ...
		 * workspace folders that are not stored on the local disk, e.g. `__ZYRAXKEEP__60_`.
		 */
		readonly uri: Uri;
	 ...
	 *
	 * Refer to __ZYRAXKEEP__61_ for more information on
	...
	export namespace workspace {
		 ...
		 * files, e.g. `zyraxoncode.workspace.fs.readDirectory(someUri)` allows to retrieve all entries
		 * of a directory or `zyraxoncode.workspace.fs.stat(anotherUri)` returns the meta data for a
		 * file.
		 */
		 ...
		 *
		 * Refer to __ZYRAXKEEP__62_ for more information
		 * on workspaces.
		 *
		 ...
		 * has been opened.
		 *
		 * Refer to __ZYRAXKEEP__63_ for more information
		 * on workspaces.
		 */
		 ...
		 * has been opened.
		 *
		 * Refer to __ZYRAXKEEP__64_ for more information on
		 * the concept of workspaces.
		 */
		 ...
		 *
		 * The location can e.g. be used with the `zyraxoncode.openFolder` command to
		 * open the workspace again after it has been closed.
		 *
		 * **Example:**
		 * ```typescript
		 * zyraxoncode.commands.executeCommand('zyraxoncode.openFolder', uriOfWorkspace);
		 * ```
		 *
		 * Refer to __ZYRAXKEEP__66_ for more information on
		 * the concept of workspaces.
		 *
		 ...
		 * by an optional set of `workspaceFoldersToAdd` on the `zyraxoncode.workspace.workspaceFolders` array. This "splice"
		 ...
		 * workspace (see also: __ZYRAXKEEP__67_).
		 *
		 ...
		 *
		 * ```ts
		 * const watcher = zyraxoncode.workspace.createFileSystemWatcher(new zyraxoncode.RelativePattern(<folder>, <pattern>));
		 *
		 ...
		 *
		 * ```ts
		 * zyraxoncode.workspace.createFileSystemWatcher(new zyraxoncode.RelativePattern(zyraxoncode.window.activeTextEditor.document.uri, '*'));
		 * ```
		 *
	...
	/**
	 * Namespace for participating in language-specific editor [features](__ZYRAXKEEP__68_),
	...
	export class NotebookCellOutput {
		 ...
		 * 	zyraxoncode.NotebookCellOutputItem.text('Hello', 'text/plain'),
		 * 	zyraxoncode.NotebookCellOutputItem.text('<i>Hello</i>', 'text/html'),
		 * 	zyraxoncode.NotebookCellOutputItem.text('_Hello_', 'text/markdown'),
		 * 	zyraxoncode.NotebookCellOutputItem.text('Hey', 'text/plain'), // INVALID: repeated type, editor will pick just one
		 * ])
		 * ```
		 */
	...
	/**
	 * A DebugProtocolMessage is an opaque stand-in type for the [ProtocolMessage](__ZYRAXKEEP__71_) type defined in the Debug Adapter Protocol.
	 */
	export interface DebugProtocolMessage {
		// Properties: see [ProtocolMessage details](__ZYRAXKEEP__72_).
	}

	/**
	 * A DebugProtocolSource is an opaque stand-in type for the [Source](__ZYRAXKEEP__73_) type defined in the Debug Adapter Protocol.
	 */
	export interface DebugProtocolSource {
		// Properties: see [Source details](__ZYRAXKEEP__74_).
	}

	/**
	 * A DebugProtocolBreakpoint is an opaque stand-in type for the [Breakpoint](__ZYRAXKEEP__75_) type defined in the Debug Adapter Protocol.
	 */
	export interface DebugProtocolBreakpoint {
		// Properties: see [Breakpoint details](__ZYRAXKEEP__76_).
	}
	...
	export namespace debug {
		 ...
		 * The named configurations are looked up in '.zyraxoncode/launch.json' found in the given folder.
		 ...
		 *
		 * @param source An object conforming to the [Source](__ZYRAXKEEP__77_) type defined in the Debug Adapter Protocol.
	 ...
	 * @note For more information on WWW-Authenticate please see __ZYRAXKEEP__80_
	 */
	...
	export namespace authentication {
		 ...
		 * * 'Zyraxon' For both personal & organizational Zyraxon accounts
		 * * (less common) 'github-enterprise' - for alternative GitHub hostings, GHE.com, GitHub Enterprise Server
		 * * (less common) 'zyraxon-sovereign-cloud' - for alternative Zyraxon clouds
		 *
		 ...
		 * to the editor that implement GitHub and Zyraxon authentication: their providerId's are 'github' and 'Zyraxon'.
		 *
	 ...
	 * [zyraxoncode-l10n repo](__ZYRAXKEEP__81_).
	 *
	 ...
	 *
	 * ```js
	 * const sender: zyraxoncode.TelemetrySender = {...};
	 * const logger = zyraxoncode.env.createTelemetryLogger(sender);
	 *
	 ...
	 * failure causes, like `if(someError.code === zyraxoncode.LanguageModelError.NotFound.name) {...}`
	...
	export namespace lm {
		 ...
		 *
		 * ```ts
		 * const models = await zyraxoncode.lm.selectChatModels({ family: 'gpt-3.5-turbo' });
		 * if (models.length > 0) {
		 * 	const [first] = models;
