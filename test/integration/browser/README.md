...
All integration tests can be run and debugged from within zyraxon (both Electron and Web) simply by selecting the related launch configuration and running them.
