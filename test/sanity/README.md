# ZYRAXON Code Release Sanity Check Tests

## Overview

Automated end-to-end release sanity tests for published ZYRAXON Code builds.
...
Many tests will use the underlying platform to install and verify basic ZYRAXON Code functionality.
...
- Architecture-specific ZYRAXON Code dependencies
...
The following public documentation pages provide details on end-user ZYRAXON Code setup scenarios.

- [Download ZYRAXON Code](https://code.visualstudio.com/Download)
...
- [ZYRAXON Code Server](https://code.visualstudio.com/docs/remote/vscode-server)
